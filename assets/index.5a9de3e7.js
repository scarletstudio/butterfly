 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const I=function(t,e){if(!t)throw pi(e)},pi=function(t){return new Error("Firebase Database ("+c_.SDK_VERSION+") INTERNAL ASSERT FAILED: "+t)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xk(t){return p_(void 0,t)}function p_(t,e){if(!(e instanceof Object))return e;switch(e.constructor){case Date:const n=e;return new Date(n.getTime());case Object:t===void 0&&(t={});break;case Array:t=[];break;default:return e}for(const n in e)!e.hasOwnProperty(n)||!bk(n)||(t[n]=p_(t[n],e[n]));return t}function bk(t){return t!=="__proto__"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Lk="FirebaseError";class mi extends Error{constructor(e,n,r){super(n),this.code=e,this.customData=r,this.name=Lk,Object.setPrototypeOf(this,mi.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Gs.prototype.create)}}class Gs{constructor(e,n,r){this.service=e,this.serviceName=n,this.errors=r}create(e,...n){const r=n[0]||{},i=`${this.service}/${e}`,s=this.errors[e],o=s?Mk(s,r):"Error",a=`${this.serviceName}: ${o} (${i}).`;return new mi(i,a,r)}}function Mk(t,e){return t.replace(Dk,(n,r)=>{const i=e[r];return i!=null?String(i):`<${r}?>`})}const Dk=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const v_=function(t){let e={},n={},r={},i="";try{const s=t.split(".");e=xs(zc(s[0])||""),n=xs(zc(s[1])||""),i=s[2],r=n.d||{},delete n.d}catch{}return{header:e,claims:n,data:r,signature:i}},Fk=function(t){const e=v_(t),n=e.claims;return!!n&&typeof n=="object"&&n.hasOwnProperty("iat")},Uk=function(t){const e=v_(t).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qi(t,e){return new Promise((n,r)=>{t.onsuccess=i=>{n(i.target.result)},t.onerror=i=>{var s;r(`${e}: ${(s=i.target.error)===null||s===void 0?void 0:s.message}`)}})}class hm{constructor(e){this._db=e,this.objectStoreNames=this._db.objectStoreNames}transaction(e,n="readonly"){return new y_(this._db.transaction.call(this._db,e,n))}createObjectStore(e,n){return new __(this._db.createObjectStore(e,n))}close(){this._db.close()}}class y_{constructor(e){this._transaction=e,this.complete=new Promise((n,r)=>{this._transaction.oncomplete=function(){n()},this._transaction.onerror=()=>{r(this._transaction.error)},this._transaction.onabort=()=>{r(this._transaction.error)}})}objectStore(e){return new __(this._transaction.objectStore(e))}}class __{constructor(e){this._store=e}index(e){return new pm(this._store.index(e))}createIndex(e,n,r){return new pm(this._store.createIndex(e,n,r))}get(e){const n=this._store.get(e);return qi(n,"Error reading from IndexedDB")}put(e,n){const r=this._store.put(e,n);return qi(r,"Error writing to IndexedDB")}delete(e){const n=this._store.delete(e);return qi(n,"Error deleting from IndexedDB")}clear(){const e=this._store.clear();return qi(e,"Error clearing IndexedDB object store")}}class pm{constructor(e){this._index=e}get(e){const n=this._index.get(e);return qi(n,"Error reading from IndexedDB")}}function Hk(t,e,n){return new Promise((r,i)=>{try{const s=indexedDB.open(t,e);s.onsuccess=o=>{r(new hm(o.target.result))},s.onerror=o=>{var a;i(`Error opening indexedDB: ${(a=o.target.error)===null||a===void 0?void 0:a.message}`)},s.onupgradeneeded=o=>{n(new hm(s.result),o.oldVersion,o.newVersion,new y_(s.transaction))}}catch(s){i(`Error opening indexedDB: ${s.message}`)}})}class rr{constructor(e,n,r){this.name=e,this.instanceFactory=n,this.type=r,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(e){return this.instantiationMode=e,this}setMultipleInstances(e){return this.multipleInstances=e,this}setServiceProps(e){return this.serviceProps=e,this}setInstanceCreatedCallback(e){return this.onInstanceCreated=e,this}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ks=II;function PI(t,e={}){typeof e!="object"&&(e={name:e});const n=Object.assign({name:w_,automaticDataCollectionEnabled:!1},e),r=n.name;if(typeof r!="string"||!r)throw ir.create("bad-app-name",{appName:String(r)});const i=ba.get(r);if(i){if(xa(t,i.options)&&xa(n,i.config))return i;throw ir.create("duplicate-app",{appName:r})}const s=new Yk(r);for(const a of jc.values())s.addComponent(a);const o=new bI(t,n,s);return ba.set(r,o),o}function E_(t=w_){const e=ba.get(t);if(!e)throw ir.create("no-app",{appName:t});return e}function _n(t,e,n){var r;let i=(r=TI[t])!==null&&r!==void 0?r:t;n&&(i+=`-${n}`);const s=i.match(/\s|\//),o=e.match(/\s|\//);if(s||o){const a=[`Unable to register library "${i}" with version "${e}":`];s&&a.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Cf.warn(a.join(" "));return}ti(new rr(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const RI="firebase-heartbeat-database",AI=1,bs="firebase-heartbeat-store";let yu=null;function C_(){return yu||(yu=Hk(RI,AI,(t,e)=>{switch(e){case 0:t.createObjectStore(bs)}}).catch(t=>{throw ir.create("storage-open",{originalErrorMessage:t.message})})),yu}async function OI(t){try{return(await C_()).transaction(bs).objectStore(bs).get(S_(t))}catch(e){throw ir.create("storage-get",{originalErrorMessage:e.message})}}async function gm(t,e){try{const r=(await C_()).transaction(bs,"readwrite");return await r.objectStore(bs).put(e,S_(t)),r.complete}catch(n){throw ir.create("storage-set",{originalErrorMessage:n.message})}}function S_(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
***************************************************************************** */function If(t,e){var n={};for(var r in t)Object.prototype.hasOwnProperty.call(t,r)&&e.indexOf(r)<0&&(n[r]=t[r]);if(t!=null&&typeof Object.getOwnPropertySymbols=="function")for(var i=0,r=Object.getOwnPropertySymbols(t);i<r.length;i++)e.indexOf(r[i])<0&&Object.prototype.propertyIsEnumerable.call(t,r[i])&&(n[r[i]]=t[r[i]]);return n}function A_(){return{["dependent-sdk-initialized-before-auth"]:"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const IT=A_,O_=new Gs("auth","Firebase",A_());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Em=new Ef("@firebase/auth");function Yo(t,...e){Em.logLevel<=K.ERROR&&Em.error(`Auth (${Ks}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ut(t,...e){throw Tf(t,...e)}function St(t,...e){return Tf(t,...e)}function L_(t,e,n){const r=Object.assign(Object.assign({},IT()),{[e]:n});return new Gs("auth","Firebase",r).create(e,{appName:t.name})}function TT(t,e,n){const r=n;if(!(e instanceof r))throw r.name!==e.constructor.name&&ut(t,"argument-error"),L_(t,"argument-error",`Type of ${e.constructor.name} does not match expected instance.Did you pass a reference from a different Auth SDK?`)}function Tf(t,...e){if(typeof t!="string"){const n=e[0],r=[...e.slice(1)];return r[0]&&(r[0].appName=t.name),t._errorFactory.create(n,...r)}return O_.create(t,...e)}function F(t,e,...n){if(!t)throw Tf(e,...n)}function Dt(t){const e="INTERNAL ASSERTION FAILED: "+t;throw Yo(e),new Error(e)}function Gt(t,e){t||Dt(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qs{constructor(e,n){this.shortDelay=e,this.longDelay=n,Gt(n>e,"Short delay should be less than long delay!"),this.isMobile=wf()||m_()}get(){return PT()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function HT(t,e){const n=await D_(t,{},async()=>{const r=gi({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:i,apiKey:s}=t.config,o=F_(t,i,"/v1/token",`key=${s}`),a=await t._getAdditionalHeaders();return a["Content-Type"]="application/x-www-form-urlencoded",M_.fetch()(o,{method:"POST",headers:a,body:r})});return{accessToken:n.access_token,expiresIn:n.expires_in,refreshToken:n.refresh_token}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rs{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){F(e.idToken,"internal-error"),F(typeof e.idToken!="undefined","internal-error"),F(typeof e.refreshToken!="undefined","internal-error");const n="expiresIn"in e&&typeof e.expiresIn!="undefined"?Number(e.expiresIn):UT(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,n)}async getToken(e,n=!1){return F(!this.accessToken||this.refreshToken,e,"user-token-expired"),!n&&this.accessToken&&!this.isExpired?this.accessToken:this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null}clearRefreshToken(){this.refreshToken=null}async refresh(e,n){const{accessToken:r,refreshToken:i,expiresIn:s}=await HT(e,n);this.updateTokensAndExpiration(r,i,Number(s))}updateTokensAndExpiration(e,n,r){this.refreshToken=n||null,this.accessToken=e||null,this.expirationTime=Date.now()+r*1e3}static fromJSON(e,n){const{refreshToken:r,accessToken:i,expirationTime:s}=n,o=new Rs;return r&&(F(typeof r=="string","internal-error",{appName:e}),o.refreshToken=r),i&&(F(typeof i=="string","internal-error",{appName:e}),o.accessToken=i),s&&(F(typeof s=="number","internal-error",{appName:e}),o.expirationTime=s),o}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new Rs,this.toJSON())}_performRefresh(){return Dt("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class z_{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(e,n){this.storage[e]=n}async _get(e){const n=this.storage[e];return n===void 0?null:n}async _remove(e){delete this.storage[e]}_addListener(e,n){}_removeListener(e,n){}}z_.type="NONE";const km=z_;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Im(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(j_(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if($_(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(H_(e))return"Blackberry";if(V_(e))return"Webos";if(bf(e))return"Safari";if((e.includes("chrome/")||B_(e))&&!e.includes("edge/"))return"Chrome";if(W_(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=t.match(n);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function $_(t=xe()){return/firefox\//i.test(t)}function bf(t=xe()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function B_(t=xe()){return/crios\//i.test(t)}function j_(t=xe()){return/iemobile/i.test(t)}function W_(t=xe()){return/android/i.test(t)}function H_(t=xe()){return/blackberry/i.test(t)}function V_(t=xe()){return/webos/i.test(t)}function Cl(t=xe()){return/iphone|ipad|ipod/i.test(t)}function VT(t=xe()){var e;return Cl(t)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function qT(){return Rk()&&document.documentMode===10}function q_(t=xe()){return Cl(t)||W_(t)||V_(t)||H_(t)||/windows phone/i.test(t)||j_(t)}function GT(){try{return!!(window&&window!==window.top)}catch{return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function G_(t,e=[]){let n;switch(t){case"Browser":n=Im(xe());break;case"Worker":n=`${Im(xe())}-${t}`;break;default:n=t}const r=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${Ks}/${r}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xs extends Af{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function r2(t,e,n=!1){const{auth:r}=t,i="reauthenticate";try{const s=await ni(t,Y_(r,i,e,t),n);F(s.idToken,r,"internal-error");const o=xf(s.idToken);F(o,r,"internal-error");const{sub:a}=o;return F(t.uid===a,r,"user-mismatch"),ri._forOperation(t,i,s)}catch(s){throw(s==null?void 0:s.code)==="auth/user-not-found"&&ut(r,"user-mismatch"),s}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function K_(t,e,n=!1){const r="signIn",i=await Y_(t,r,e),s=await ri._fromIdTokenResponse(t,r,i);return n||await t._updateCurrentUser(s.user),s}async function i2(t,e){return K_(Sl(t),e)}function s2(t,e,n){return i2(He(t),yi.credential(e,n))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class J_ extends Q_{constructor(){super(()=>window.sessionStorage,"SESSION")}_addListener(e,n){}_removeListener(e,n){}}J_.type="SESSION";const Z_=J_;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function e0(){return typeof kt().WorkerGlobalScope!="undefined"&&typeof kt().importScripts=="function"}async function v2(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function y2(){var t;return((t=navigator==null?void 0:navigator.serviceWorker)===null||t===void 0?void 0:t.controller)||null}function _2(){return e0()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function i0(t,e){return e?Ft(e):(F(t._popupRedirectResolver,t,"argument-error"),t._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class s0{constructor(e,n,r,i,s=!1){this.auth=e,this.resolver=r,this.user=i,this.bypassAuthState=s,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(n)?n:[n]}execute(){return new Promise(async(e,n)=>{this.pendingPromise={resolve:e,reject:n};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:n,sessionId:r,postBody:i,tenantId:s,error:o,type:a}=e;if(o){this.reject(o);return}const l={auth:this.auth,requestUri:n,sessionId:r,tenantId:s||void 0,postBody:i||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(a)(l))}catch(u){this.reject(u)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return b2;case"linkViaPopup":case"linkViaRedirect":return R2;case"reauthViaPopup":case"reauthViaRedirect":return P2;default:ut(this.auth,"internal-error")}}resolve(e){Gt(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){Gt(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const L2="pendingRedirect",Cu=new Map;class M2 extends s0{constructor(e,n,r=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],n,void 0,r),this.eventId=null}async execute(){let e=Cu.get(this.auth._key());if(!e){try{const r=await D2(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(r)}catch(n){e=()=>Promise.reject(n)}Cu.set(this.auth._key(),e)}return this.bypassAuthState||Cu.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const n=await this.auth._redirectUserForId(e.eventId);if(n)return this.user=n,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function D2(t,e){const n=U2(e),r=F2(t);if(!await r._isAvailable())return!1;const i=await r._get(n)==="true";return await r._remove(n),i}function F2(t){return Ft(t._redirectPersistence)}function U2(t){return Ko(L2,t.config.apiKey,t.name)}async function z2(t,e,n=!1){const r=Sl(t),i=i0(r,e),o=await new M2(r,i,n).execute();return o&&!n&&(delete o.user._redirectEventId,await r._persistUserIfCurrent(o.user),await r._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $2=10*60*1e3;class B2{constructor(e){this.auth=e,this.cachedEventUids=new Set,this.consumers=new Set,this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1,this.lastProcessedEventTime=Date.now()}registerConsumer(e){this.consumers.add(e),this.queuedRedirectEvent&&this.isEventForConsumer(this.queuedRedirectEvent,e)&&(this.sendToConsumer(this.queuedRedirectEvent,e),this.saveEventToCache(this.queuedRedirectEvent),this.queuedRedirectEvent=null)}unregisterConsumer(e){this.consumers.delete(e)}onEvent(e){if(this.hasEventBeenHandled(e))return!1;let n=!1;return this.consumers.forEach(r=>{this.isEventForConsumer(e,r)&&(n=!0,this.sendToConsumer(e,r),this.saveEventToCache(e))}),this.hasHandledPotentialRedirect||!j2(e)||(this.hasHandledPotentialRedirect=!0,n||(this.queuedRedirectEvent=e,n=!0)),n}sendToConsumer(e,n){var r;if(e.error&&!o0(e)){const i=((r=e.error.code)===null||r===void 0?void 0:r.split("auth/")[1])||"internal-error";n.onError(St(this.auth,i))}else n.onAuthEvent(e)}isEventForConsumer(e,n){const r=n.eventId===null||!!e.eventId&&e.eventId===n.eventId;return n.filter.includes(e.type)&&r}hasEventBeenHandled(e){return Date.now()-this.lastProcessedEventTime>=$2&&this.cachedEventUids.clear(),this.cachedEventUids.has(Pm(e))}saveEventToCache(e){this.cachedEventUids.add(Pm(e)),this.lastProcessedEventTime=Date.now()}}function Pm(t){return[t.type,t.eventId,t.sessionId,t.tenantId].filter(e=>e).join("-")}function o0({type:t,error:e}){return t==="unknown"&&(e==null?void 0:e.code)==="auth/no-auth-event"}function j2(t){switch(t.type){case"signInViaRedirect":case"linkViaRedirect":case"reauthViaRedirect":return!0;case"unknown":return o0(t);default:return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const X2=new Qs(5e3,15e3),J2="__/auth/iframe",Z2="emulator/auth/iframe",eN={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},tN=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function nN(t){const e=t.config;F(e.authDomain,t,"auth-domain-config-required");const n=e.emulator?Nf(e,Z2):`https://${t.config.authDomain}/${J2}`,r={apiKey:e.apiKey,appName:t.name,v:Ks},i=tN.get(t.config.apiHost);i&&(r.eid=i);const s=t._getFrameworks();return s.length&&(r.fw=s.join(",")),`${n}?${gi(r).slice(1)}`}async function rN(t){const e=await Q2(t),n=kt().gapi;return F(n,t,"internal-error"),e.open({where:document.body,url:nN(t),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:eN,dontclear:!0},r=>new Promise(async(i,s)=>{await r.restyle({setHideOnLeave:!1});const o=St(t,"network-request-failed"),a=kt().setTimeout(()=>{s(o)},X2.get());function l(){kt().clearTimeout(a),i(r)}r.ping(l).then(l,()=>{s(o)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dN="__/auth/handler",fN="emulator/auth/handler";function Om(t,e,n,r,i,s){F(t.config.authDomain,t,"auth-domain-config-required"),F(t.config.apiKey,t,"invalid-api-key");const o={apiKey:t.config.apiKey,appName:t.name,authType:n,redirectUrl:r,v:Ks,eventId:i};if(e instanceof Af){e.setDefaultLanguage(t.languageCode),o.providerId=e.providerId||"",$c(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[l,u]of Object.entries(s||{}))o[l]=u}if(e instanceof Xs){const l=e.getScopes().filter(u=>u!=="");l.length>0&&(o.scopes=l.join(","))}t.tenantId&&(o.tid=t.tenantId);const a=o;for(const l of Object.keys(a))a[l]===void 0&&delete a[l];return`${hN(t)}?${gi(a).slice(1)}`}function hN({config:t}){return t.emulator?Nf(t,fN):`https://${t.authDomain}/${dN}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tl(t=E_()){const e=Sf(t,"auth");return e.isInitialized()?e.getImmediate():NT(t,{popupRedirectResolver:mN,persistence:[I2,h2,Z_]})}yN("Browser");async function _N(){try{const t=Tl(),e=new At,{user:n}=await O2(t,e);return{user:n,signInError:null}}catch(t){return{user:null,signInError:t}}}async function a0(){try{const t=Tl();return await u2(t),{isSuccess:!0,signOutError:null}}catch(t){return{isSuccess:!1,signOutError:t}}}function Zs(){const[t,e]=R.exports.useState(null),n=Tl();return R.exports.useEffect(()=>l2(n,i=>{e(s=>(s==null?void 0:s.uid)!==(i==null?void 0:i.uid)?i:s)}),[n]),t}function l0({authUser:t,doLogOut:e}){return t&&T("div",{children:[h("hr",{}),T("p",{children:["Currently logged in as ",t.displayName,"."]}),h("p",{children:h(at,{to:"/chats",children:"Go to Chats"})}),h("p",{children:T("span",{className:"Button",role:"button",tabIndex:0,onClick:e,onKeyDown:e,children:[h(We,{icon:wC,className:"IconBefore"}),h("span",{children:"Log Out"})]})})]})}const Dm="@firebase/database",Fm="0.12.8";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const c0=function(t){try{if(typeof window!="undefined"&&typeof window[t]!="undefined"){const e=window[t];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new EN(e)}}catch{}return new CN},Vn=c0("localStorage"),Gc=c0("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ff="5",p0="v",m0="s",g0="r",v0="f",y0=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,_0="ls",FN="p",Qc="ac",w0="websocket",E0="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $m="start",WN="close",HN="pLPCommand",VN="pRTLPCB",S0="id",k0="pw",I0="ser",qN="cb",GN="seg",YN="ts",KN="d",QN="dframe",T0=1870,N0=30,XN=T0-N0,JN=25e3,ZN=3e4;class Or{constructor(e,n,r,i,s,o,a){this.connId=e,this.repoInfo=n,this.applicationId=r,this.appCheckToken=i,this.authToken=s,this.transportSessionId=o,this.lastSessionId=a,this.bytesSent=0,this.bytesReceived=0,this.everConnected_=!1,this.log_=to(e),this.stats_=Uf(n),this.urlFn=l=>(this.appCheckToken&&(l[Qc]=this.appCheckToken),C0(n,E0,l))}open(e,n){this.curSegmentNum=0,this.onDisconnect_=n,this.myPacketOrderer=new jN(e),this.isClosed_=!1,this.connectTimeoutTimer_=setTimeout(()=>{this.log_("Timed out trying to connect."),this.onClosed_(),this.connectTimeoutTimer_=null},Math.floor(ZN)),TN(()=>{if(this.isClosed_)return;this.scriptTagHolder=new zf((...s)=>{const[o,a,l,u,c]=s;if(this.incrementIncomingBytes_(s),!!this.scriptTagHolder)if(this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null),this.everConnected_=!0,o===$m)this.id=a,this.password=l;else if(o===WN)a?(this.scriptTagHolder.sendNewPolls=!1,this.myPacketOrderer.closeAfter(a,()=>{this.onClosed_()})):this.onClosed_();else throw new Error("Unrecognized command received: "+o)},(...s)=>{const[o,a]=s;this.incrementIncomingBytes_(s),this.myPacketOrderer.handleResponse(o,a)},()=>{this.onClosed_()},this.urlFn);const r={};r[$m]="t",r[I0]=Math.floor(Math.random()*1e8),this.scriptTagHolder.uniqueCallbackIdentifier&&(r[qN]=this.scriptTagHolder.uniqueCallbackIdentifier),r[p0]=Ff,this.transportSessionId&&(r[m0]=this.transportSessionId),this.lastSessionId&&(r[_0]=this.lastSessionId),this.applicationId&&(r[FN]=this.applicationId),this.appCheckToken&&(r[Qc]=this.appCheckToken),typeof location!="undefined"&&location.hostname&&y0.test(location.hostname)&&(r[g0]=v0);const i=this.urlFn(r);this.log_("Connecting via long-poll to "+i),this.scriptTagHolder.addTag(i,()=>{})})}start(){this.scriptTagHolder.startLongPoll(this.id,this.password),this.addDisconnectPingFrame(this.id,this.password)}static forceAllow(){Or.forceAllow_=!0}static forceDisallow(){Or.forceDisallow_=!0}static isAvailable(){return Or.forceAllow_?!0:!Or.forceDisallow_&&typeof document!="undefined"&&document.createElement!=null&&!xN()&&!bN()}markConnectionHealthy(){}shutdown_(){this.isClosed_=!0,this.scriptTagHolder&&(this.scriptTagHolder.close(),this.scriptTagHolder=null),this.myDisconnFrame&&(document.body.removeChild(this.myDisconnFrame),this.myDisconnFrame=null),this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null)}onClosed_(){this.isClosed_||(this.log_("Longpoll is closing itself"),this.shutdown_(),this.onDisconnect_&&(this.onDisconnect_(this.everConnected_),this.onDisconnect_=null))}close(){this.isClosed_||(this.log_("Longpoll is being closed."),this.shutdown_())}send(e){const n=_e(e);this.bytesSent+=n.length,this.stats_.incrementCounter("bytes_sent",n.length);const r=f_(n),i=f0(r,XN);for(let s=0;s<i.length;s++)this.scriptTagHolder.enqueueSegment(this.curSegmentNum,i.length,i[s]),this.curSegmentNum++}addDisconnectPingFrame(e,n){this.myDisconnFrame=document.createElement("iframe");const r={};r[QN]="t",r[S0]=e,r[k0]=n,this.myDisconnFrame.src=this.urlFn(r),this.myDisconnFrame.style.display="none",document.body.appendChild(this.myDisconnFrame)}incrementIncomingBytes_(e){const n=_e(e).length;this.bytesReceived+=n,this.stats_.incrementCounter("bytes_received",n)}}class zf{constructor(e,n,r,i){this.onDisconnect=r,this.urlFn=i,this.outstandingRequests=new Set,this.pendingSegs=[],this.currentSerial=Math.floor(Math.random()*1e8),this.sendNewPolls=!0;{this.uniqueCallbackIdentifier=SN(),window[HN+this.uniqueCallbackIdentifier]=e,window[VN+this.uniqueCallbackIdentifier]=n,this.myIFrame=zf.createIFrame_();let s="";if(this.myIFrame.src&&this.myIFrame.src.substr(0,11)==="javascript:"){const a=document.domain;s='<script>document.domain="'+a+'";<\/script>'}const o="<html><body>"+s+"</body></html>";try{this.myIFrame.doc.open(),this.myIFrame.doc.write(o),this.myIFrame.doc.close()}catch(a){we("frame writing exception"),a.stack&&we(a.stack),we(a)}}}static createIFrame_(){const e=document.createElement("iframe");if(e.style.display="none",document.body){document.body.appendChild(e);try{e.contentWindow.document||we("No IE domain setting required")}catch{const r=document.domain;e.src="javascript:void((function(){document.open();document.domain='"+r+"';document.close();})())"}}else throw"Document body has not initialized. Wait to initialize Firebase until after the document is ready.";return e.contentDocument?e.doc=e.contentDocument:e.contentWindow?e.doc=e.contentWindow.document:e.document&&(e.doc=e.document),e}close(){this.alive=!1,this.myIFrame&&(this.myIFrame.doc.body.innerHTML="",setTimeout(()=>{this.myIFrame!==null&&(document.body.removeChild(this.myIFrame),this.myIFrame=null)},Math.floor(0)));const e=this.onDisconnect;e&&(this.onDisconnect=null,e())}startLongPoll(e,n){for(this.myID=e,this.myPW=n,this.alive=!0;this.newRequest_(););}newRequest_(){if(this.alive&&this.sendNewPolls&&this.outstandingRequests.size<(this.pendingSegs.length>0?2:1)){this.currentSerial++;const e={};e[S0]=this.myID,e[k0]=this.myPW,e[I0]=this.currentSerial;let n=this.urlFn(e),r="",i=0;for(;this.pendingSegs.length>0&&this.pendingSegs[0].d.length+N0+r.length<=T0;){const o=this.pendingSegs.shift();r=r+"&"+GN+i+"="+o.seg+"&"+YN+i+"="+o.ts+"&"+KN+i+"="+o.d,i++}return n=n+r,this.addLongPollTag_(n,this.currentSerial),!0}else return!1}enqueueSegment(e,n,r){this.pendingSegs.push({seg:e,ts:n,d:r}),this.alive&&this.newRequest_()}addLongPollTag_(e,n){this.outstandingRequests.add(n);const r=()=>{this.outstandingRequests.delete(n),this.newRequest_()},i=setTimeout(r,Math.floor(JN)),s=()=>{clearTimeout(i),r()};this.addTag(e,s)}addTag(e,n){setTimeout(()=>{try{if(!this.sendNewPolls)return;const r=this.myIFrame.doc.createElement("script");r.type="text/javascript",r.async=!0,r.src=e,r.onload=r.onreadystatechange=function(){const i=r.readyState;(!i||i==="loaded"||i==="complete")&&(r.onload=r.onreadystatechange=null,r.parentNode&&r.parentNode.removeChild(r),n())},r.onerror=()=>{we("Long-poll script failed to load: "+e),this.sendNewPolls=!1,this.close()},this.myIFrame.doc.body.appendChild(r)}catch{}},Math.floor(1))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class b0{constructor(e){this.allowedEvents_=e,this.listeners_={},I(Array.isArray(e)&&e.length>0,"Requires a non-empty array")}trigger(e,...n){if(Array.isArray(this.listeners_[e])){const r=[...this.listeners_[e]];for(let i=0;i<r.length;i++)r[i].callback.apply(r[i].context,n)}}on(e,n,r){this.validateEventType_(e),this.listeners_[e]=this.listeners_[e]||[],this.listeners_[e].push({callback:n,context:r});const i=this.getInitialEvent(e);i&&n.apply(r,i)}off(e,n,r){this.validateEventType_(e);const i=this.listeners_[e]||[];for(let s=0;s<i.length;s++)if(i[s].callback===n&&(!r||r===i[s].context)){i.splice(s,1);return}}validateEventType_(e){I(this.allowedEvents_.find(n=>n===e),"Unknown event: "+e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gm=32,Ym=768;class Y{constructor(e,n){if(n===void 0){this.pieces_=e.split("/");let r=0;for(let i=0;i<this.pieces_.length;i++)this.pieces_[i].length>0&&(this.pieces_[r]=this.pieces_[i],r++);this.pieces_.length=r,this.pieceNum_=0}else this.pieces_=e,this.pieceNum_=n}toString(){let e="";for(let n=this.pieceNum_;n<this.pieces_.length;n++)this.pieces_[n]!==""&&(e+="/"+this.pieces_[n]);return e||"/"}}function q(){return new Y("")}function $(t){return t.pieceNum_>=t.pieces_.length?null:t.pieces_[t.pieceNum_]}function Nn(t){return t.pieces_.length-t.pieceNum_}function X(t){let e=t.pieceNum_;return e<t.pieces_.length&&e++,new Y(t.pieces_,e)}function Bf(t){return t.pieceNum_<t.pieces_.length?t.pieces_[t.pieces_.length-1]:null}function cx(t){let e="";for(let n=t.pieceNum_;n<t.pieces_.length;n++)t.pieces_[n]!==""&&(e+="/"+encodeURIComponent(String(t.pieces_[n])));return e||"/"}function Os(t,e=0){return t.pieces_.slice(t.pieceNum_+e)}function P0(t){if(t.pieceNum_>=t.pieces_.length)return null;const e=[];for(let n=t.pieceNum_;n<t.pieces_.length-1;n++)e.push(t.pieces_[n]);return new Y(e,0)}function ae(t,e){const n=[];for(let r=t.pieceNum_;r<t.pieces_.length;r++)n.push(t.pieces_[r]);if(e instanceof Y)for(let r=e.pieceNum_;r<e.pieces_.length;r++)n.push(e.pieces_[r]);else{const r=e.split("/");for(let i=0;i<r.length;i++)r[i].length>0&&n.push(r[i])}return new Y(n,0)}function B(t){return t.pieceNum_>=t.pieces_.length}function Ue(t,e){const n=$(t),r=$(e);if(n===null)return e;if(n===r)return Ue(X(t),X(e));throw new Error("INTERNAL ERROR: innerPath ("+e+") is not within outerPath ("+t+")")}function dx(t,e){const n=Os(t,0),r=Os(e,0);for(let i=0;i<n.length&&i<r.length;i++){const s=pr(n[i],r[i]);if(s!==0)return s}return n.length===r.length?0:n.length<r.length?-1:1}function jf(t,e){if(Nn(t)!==Nn(e))return!1;for(let n=t.pieceNum_,r=e.pieceNum_;n<=t.pieces_.length;n++,r++)if(t.pieces_[n]!==e.pieces_[r])return!1;return!0}function rt(t,e){let n=t.pieceNum_,r=e.pieceNum_;if(Nn(t)>Nn(e))return!1;for(;n<t.pieces_.length;){if(t.pieces_[n]!==e.pieces_[r])return!1;++n,++r}return!0}class fx{constructor(e,n){this.errorPrefix_=n,this.parts_=Os(e,0),this.byteLength_=Math.max(1,this.parts_.length);for(let r=0;r<this.parts_.length;r++)this.byteLength_+=ml(this.parts_[r]);R0(this)}}function hx(t,e){t.parts_.length>0&&(t.byteLength_+=1),t.parts_.push(e),t.byteLength_+=ml(e),R0(t)}function px(t){const e=t.parts_.pop();t.byteLength_-=ml(e),t.parts_.length>0&&(t.byteLength_-=1)}function R0(t){if(t.byteLength_>Ym)throw new Error(t.errorPrefix_+"has a key path longer than "+Ym+" bytes ("+t.byteLength_+").");if(t.parts_.length>Gm)throw new Error(t.errorPrefix_+"path specified exceeds the maximum depth that can be written ("+Gm+") or object contains a cycle "+Un(t))}function Un(t){return t.parts_.length===0?"":"in property '"+t.parts_.join(".")+"'"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Xc;function Cx(t){Xc=t}const O0=function(t){return typeof t=="number"?"number:"+h0(t):"string:"+t},L0=function(t){if(t.isLeafNode()){const e=t.val();I(typeof e=="string"||typeof e=="number"||typeof e=="object"&&xt(e,".sv"),"Priority must be a string or number.")}else I(t===Xc||t.isEmpty(),"priority of unexpected type.");I(t===Xc||t.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let M0,D0;function Sx(t){M0=t}function kx(t){D0=t}class Ix extends Nl{compare(e,n){const r=e.node.getPriority(),i=n.node.getPriority(),s=r.compareTo(i);return s===0?pr(e.name,n.name):s}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,n){return!e.getPriority().equals(n.getPriority())}minPost(){return j.MIN}maxPost(){return new j(Tn,new me("[PRIORITY-POST]",D0))}makePost(e,n){const r=M0(e);return new j(n,new me("[PRIORITY-POST]",r))}toString(){return".priority"}}const se=new Ix;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Px extends Nl{compare(e,n){const r=e.node.compareTo(n.node);return r===0?pr(e.name,n.name):r}isDefinedOn(e){return!0}indexedValueChanged(e,n){return!e.equals(n)}minPost(){return j.MIN}maxPost(){return j.MAX}makePost(e,n){const r=ye(e);return new j(n,r)}toString(){return".value"}}const F0=new Px;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function U0(t){return{type:"value",snapshotNode:t}}function ii(t,e){return{type:"child_added",snapshotNode:e,childName:t}}function Ls(t,e){return{type:"child_removed",snapshotNode:e,childName:t}}function Ms(t,e,n){return{type:"child_changed",snapshotNode:e,childName:t,oldSnap:n}}function Ax(t,e){return{type:"child_moved",snapshotNode:e,childName:t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tg=10*1e3,jx=30*1e3,Wx=5*60*1e3;class Hx{constructor(e,n){this.server_=n,this.statsToReport_={},this.statsListener_=new Bx(e);const r=tg+(jx-tg)*Math.random();ss(this.reportStats_.bind(this),Math.floor(r))}reportStats_(){const e=this.statsListener_.get(),n={};let r=!1;Se(e,(i,s)=>{s>0&&xt(this.statsToReport_,i)&&(n[i]=s,r=!0)}),r&&this.server_.reportStats(n),ss(this.reportStats_.bind(this),Math.floor(Math.random()*2*Wx))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gt{constructor(e){this.writeTree_=e}static empty(){return new gt(new Q(null))}}function as(t,e,n){if(B(e))return new gt(new Q(n));{const r=t.writeTree_.findRootMostValueAndPath(e);if(r!=null){const i=r.path;let s=r.value;const o=Ue(i,e);return s=s.updateChild(o,n),new gt(t.writeTree_.set(i,s))}else{const i=new Q(n),s=t.writeTree_.setTree(e,i);return new gt(s)}}}function ed(t,e,n){let r=t;return Se(n,(i,s)=>{r=as(r,ae(e,i),s)}),r}function ng(t,e){if(B(e))return gt.empty();{const n=t.writeTree_.setTree(e,new Q(null));return new gt(n)}}function td(t,e){return mr(t,e)!=null}function mr(t,e){const n=t.writeTree_.findRootMostValueAndPath(e);return n!=null?t.writeTree_.get(n.path).getChild(Ue(n.path,e)):null}function rg(t){const e=[],n=t.writeTree_.value;return n!=null?n.isLeafNode()||n.forEachChild(se,(r,i)=>{e.push(new j(r,i))}):t.writeTree_.children.inorderTraversal((r,i)=>{i.value!=null&&e.push(new j(r,i.value))}),e}function wn(t,e){if(B(e))return t;{const n=mr(t,e);return n!=null?new gt(new Q(n)):new gt(t.writeTree_.subtree(e))}}function nd(t){return t.writeTree_.isEmpty()}function oi(t,e){return B0(q(),t.writeTree_,e)}function B0(t,e,n){if(e.value!=null)return n.updateChild(t,e.value);{let r=null;return e.children.inorderTraversal((i,s)=>{i===".priority"?(I(s.value!==null,"Priority writes must always be leaf nodes"),r=s.value):n=B0(ae(t,i),s,n)}),!n.getChild(t).isEmpty()&&r!==null&&(n=n.updateChild(ae(t,".priority"),r)),n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cb{constructor(){this.changeMap=new Map}trackChildChange(e){const n=e.type,r=e.childName;I(n==="child_added"||n==="child_changed"||n==="child_removed","Only child changes supported for tracking"),I(r!==".priority","Only non-priority child changes can be tracked.");const i=this.changeMap.get(r);if(i){const s=i.type;if(n==="child_added"&&s==="child_removed")this.changeMap.set(r,Ms(r,e.snapshotNode,i.snapshotNode));else if(n==="child_removed"&&s==="child_added")this.changeMap.delete(r);else if(n==="child_removed"&&s==="child_changed")this.changeMap.set(r,Ls(r,i.oldSnap));else if(n==="child_changed"&&s==="child_added")this.changeMap.set(r,ii(r,e.snapshotNode));else if(n==="child_changed"&&s==="child_changed")this.changeMap.set(r,Ms(r,e.snapshotNode,i.oldSnap));else throw pi("Illegal combination of changes: "+e+" occurred after "+i)}else this.changeMap.set(r,e)}getChanges(){return Array.from(this.changeMap.values())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Va;function Ab(t){I(!Va,"__referenceConstructor has already been defined"),Va=t}function Ob(){return I(Va,"Reference.ts has not been loaded"),Va}let Lb=1;class cg{constructor(e){this.listenProvider_=e,this.syncPointTree_=new Q(null),this.pendingWriteTree_=lb(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function J0(t,e,n,r,i){return Qx(t.pendingWriteTree_,e,n,r,i),i?wi(t,new lr(Yf(),e,n)):[]}function Mb(t,e,n,r){Xx(t.pendingWriteTree_,e,n,r);const i=Q.fromObject(n);return wi(t,new si(Yf(),e,i))}function dn(t,e,n=!1){const r=Jx(t.pendingWriteTree_,e);if(Zx(t.pendingWriteTree_,e)){let s=new Q(null);return r.snap!=null?s=s.set(q(),!0):Se(r.children,o=>{s=s.set(new Y(o),!0)}),wi(t,new $a(r.path,s,n))}else return[]}function Pl(t,e,n){return wi(t,new lr(Kf(),e,n))}function Db(t,e,n){const r=Q.fromObject(n);return wi(t,new si(Kf(),e,r))}function Fb(t,e){return wi(t,new Fs(Kf(),e))}function Ub(t,e,n){const r=rh(t,n);if(r){const i=ih(r),s=i.path,o=i.queryId,a=Ue(s,e),l=new Fs(Qf(o),a);return sh(t,s,l)}else return[]}function sd(t,e,n,r){const i=e._path,s=t.syncPointTree_.get(i);let o=[];if(s&&(e._queryIdentifier==="default"||X0(s,e))){const a=Rb(s,e,n,r);xb(s)&&(t.syncPointTree_=t.syncPointTree_.remove(i));const l=a.removed;o=a.events;const u=l.findIndex(d=>d._queryParams.loadsAllData())!==-1,c=t.syncPointTree_.findOnPath(i,(d,f)=>xn(f));if(u&&!c){const d=t.syncPointTree_.subtree(i);if(!d.isEmpty()){const f=Bb(d);for(let v=0;v<f.length;++v){const y=f[v],E=y.query,b=t1(t,y);t.listenProvider_.startListening(ls(E),qa(t,E),b.hashFn,b.onComplete)}}}!c&&l.length>0&&!r&&(u?t.listenProvider_.stopListening(ls(e),null):l.forEach(d=>{const f=t.queryToTagMap.get(Rl(d));t.listenProvider_.stopListening(ls(d),f)})),jb(t,l)}return o}function zb(t,e,n,r){const i=rh(t,r);if(i!=null){const s=ih(i),o=s.path,a=s.queryId,l=Ue(o,e),u=new lr(Qf(a),l,n);return sh(t,o,u)}else return[]}function $b(t,e,n,r){const i=rh(t,r);if(i){const s=ih(i),o=s.path,a=s.queryId,l=Ue(o,e),u=Q.fromObject(n),c=new si(Qf(a),l,u);return sh(t,o,c)}else return[]}function dg(t,e,n){const r=e._path;let i=null,s=!1;t.syncPointTree_.foreachOnPath(r,(d,f)=>{const v=Ue(d,r);i=i||Hr(f,v),s=s||xn(f)});let o=t.syncPointTree_.get(r);o?(s=s||xn(o),i=i||Hr(o,q())):(o=new Ib,t.syncPointTree_=t.syncPointTree_.set(r,o));let a;i!=null?a=!0:(a=!1,i=L.EMPTY_NODE,t.syncPointTree_.subtree(r).foreachChild((f,v)=>{const y=Hr(v,q());y&&(i=i.updateImmediateChild(f,y))}));const l=X0(o,e);if(!l&&!e._queryParams.loadsAllData()){const d=Rl(e);I(!t.queryToTagMap.has(d),"View does not exist, but we have a tag");const f=Wb();t.queryToTagMap.set(d,f),t.tagToQueryMap.set(f,d)}const u=Xf(t.pendingWriteTree_,r);let c=Pb(o,e,n,u,i,a);if(!l&&!s){const d=Q0(o,e);c=c.concat(Hb(t,e,d))}return c}function nh(t,e,n){const i=t.pendingWriteTree_,s=t.syncPointTree_.findOnPath(e,(o,a)=>{const l=Ue(o,e),u=Hr(a,l);if(u)return u});return W0(i,e,s,n,!0)}function wi(t,e){return Z0(e,t.syncPointTree_,null,Xf(t.pendingWriteTree_,q()))}function Z0(t,e,n,r){if(B(t.path))return e1(t,e,n,r);{const i=e.get(q());n==null&&i!=null&&(n=Hr(i,q()));let s=[];const o=$(t.path),a=t.operationForChild(o),l=e.children.get(o);if(l&&a){const u=n?n.getImmediateChild(o):null,c=H0(r,o);s=s.concat(Z0(a,l,u,c))}return i&&(s=s.concat(th(i,t,r,n))),s}}function e1(t,e,n,r){const i=e.get(q());n==null&&i!=null&&(n=Hr(i,q()));let s=[];return e.children.inorderTraversal((o,a)=>{const l=n?n.getImmediateChild(o):null,u=H0(r,o),c=t.operationForChild(o);c&&(s=s.concat(e1(c,a,l,u)))}),i&&(s=s.concat(th(i,t,r,n))),s}function t1(t,e){const n=e.query,r=qa(t,n);return{hashFn:()=>(Eb(e)||L.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return r?Ub(t,n._path,r):Fb(t,n._path);{const s=PN(i,n);return sd(t,n,null,s)}}}}function qa(t,e){const n=Rl(e);return t.queryToTagMap.get(n)}function Rl(t){return t._path.toString()+"$"+t._queryIdentifier}function rh(t,e){return t.tagToQueryMap.get(e)}function ih(t){const e=t.indexOf("$");return I(e!==-1&&e<t.length-1,"Bad queryKey."),{queryId:t.substr(e+1),path:new Y(t.substr(0,e))}}function sh(t,e,n){const r=t.syncPointTree_.get(e);I(r,"Missing sync point for query tag that we're tracking");const i=Xf(t.pendingWriteTree_,e);return th(r,n,i,null)}function Bb(t){return t.fold((e,n,r)=>{if(n&&xn(n))return[bl(n)];{let i=[];return n&&(i=K0(n)),Se(r,(s,o)=>{i=i.concat(o)}),i}})}function ls(t){return t._queryParams.loadsAllData()&&!t._queryParams.isDefault()?new(Ob())(t._repo,t._path):t}function jb(t,e){for(let n=0;n<e.length;++n){const r=e[n];if(!r._queryParams.loadsAllData()){const i=Rl(r),s=t.queryToTagMap.get(i);t.queryToTagMap.delete(i),t.tagToQueryMap.delete(s)}}}function Wb(){return Lb++}function Hb(t,e,n){const r=e._path,i=qa(t,e),s=t1(t,n),o=t.listenProvider_.startListening(ls(e),i,s.hashFn,s.onComplete),a=t.syncPointTree_.subtree(r);if(i)I(!xn(a.value),"If we're adding a query, it shouldn't be shadowed");else{const l=a.fold((u,c,d)=>{if(!B(u)&&c&&xn(c))return[bl(c).query];{let f=[];return c&&(f=f.concat(K0(c).map(v=>v.query))),Se(d,(v,y)=>{f=f.concat(y)}),f}});for(let u=0;u<l.length;++u){const c=l[u];t.listenProvider_.stopListening(ls(c),qa(t,c))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xb=/[\[\].#$\/\u0000-\u001F\u007F]/,Jb=/[\[\].#$\u0000-\u001F\u007F]/,bu=10*1024*1024,Ol=function(t){return typeof t=="string"&&t.length!==0&&!Xb.test(t)},a1=function(t){return typeof t=="string"&&t.length!==0&&!Jb.test(t)},Zb=function(t){return t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),a1(t)},ad=function(t){return t===null||typeof t=="string"||typeof t=="number"&&!Mf(t)||t&&typeof t=="object"&&xt(t,".sv")},io=function(t,e,n,r){r&&e===void 0||Ll(Ys(t,"value"),e,n)},Ll=function(t,e,n){const r=n instanceof Y?new fx(n,t):n;if(e===void 0)throw new Error(t+"contains undefined "+Un(r));if(typeof e=="function")throw new Error(t+"contains a function "+Un(r)+" with contents = "+e.toString());if(Mf(e))throw new Error(t+"contains "+e.toString()+" "+Un(r));if(typeof e=="string"&&e.length>bu/3&&ml(e)>bu)throw new Error(t+"contains a string greater than "+bu+" utf8 bytes "+Un(r)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let i=!1,s=!1;if(Se(e,(o,a)=>{if(o===".value")i=!0;else if(o!==".priority"&&o!==".sv"&&(s=!0,!Ol(o)))throw new Error(t+" contains an invalid key ("+o+") "+Un(r)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);hx(r,o),Ll(t,a,r),px(r)}),i&&s)throw new Error(t+' contains ".value" child '+Un(r)+" in addition to actual children.")}},eP=function(t,e){let n,r;for(n=0;n<e.length;n++){r=e[n];const s=Os(r);for(let o=0;o<s.length;o++)if(!(s[o]===".priority"&&o===s.length-1)){if(!Ol(s[o]))throw new Error(t+"contains an invalid key ("+s[o]+") in path "+r.toString()+`. Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`)}}e.sort(dx);let i=null;for(n=0;n<e.length;n++){if(r=e[n],i!==null&&rt(i,r))throw new Error(t+"contains a path "+i.toString()+" that is ancestor of another path "+r.toString());i=r}},tP=function(t,e,n,r){if(r&&e===void 0)return;const i=Ys(t,"values");if(!(e&&typeof e=="object")||Array.isArray(e))throw new Error(i+" must be an object containing the children to replace.");const s=[];Se(e,(o,a)=>{const l=new Y(o);if(Ll(i,a,ae(n,l)),Bf(l)===".priority"&&!ad(a))throw new Error(i+"contains an invalid value for '"+l.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");s.push(l)}),eP(i,s)},nP=function(t,e,n,r){if(!(r&&n===void 0)&&!Ol(n))throw new Error(Ys(t,e)+'was an invalid key = "'+n+`".  Firebase keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]").`)},dh=function(t,e,n,r){if(!(r&&n===void 0)&&!a1(n))throw new Error(Ys(t,e)+'was an invalid path = "'+n+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},rP=function(t,e,n,r){n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),dh(t,e,n,r)},l1=function(t,e){if($(e)===".info")throw new Error(t+" failed = Can't modify data under /.info/")},iP=function(t,e){const n=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!Ol(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||n.length!==0&&!Zb(n))throw new Error(Ys(t,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class g1{constructor(e,n,r,i){this.eventType=e,this.eventRegistration=n,this.snapshot=r,this.prevName=i}getPath(){const e=this.snapshot.ref;return this.eventType==="value"?e._path:e.parent._path}getEventType(){return this.eventType}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.getPath().toString()+":"+this.eventType+":"+_e(this.snapshot.exportVal())}}class v1{constructor(e,n,r){this.eventRegistration=e,this.error=n,this.path=r}getPath(){return this.path}getEventType(){return"cancel"}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.path.toString()+":cancel"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gr{constructor(e,n,r,i){this._repo=e,this._path=n,this._queryParams=r,this._orderByCalled=i}get key(){return B(this._path)?null:Bf(this._path)}get ref(){return new Qt(this._repo,this._path)}get _queryIdentifier(){const e=eg(this._queryParams),n=Df(e);return n==="{}"?"default":n}get _queryObject(){return eg(this._queryParams)}isEqual(e){if(e=He(e),!(e instanceof gr))return!1;const n=this._repo===e._repo,r=jf(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return n&&r&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+cx(this._path)}}function SP(t,e){if(t._orderByCalled===!0)throw new Error(e+": You can't combine multiple orderBy calls.")}function gh(t){let e=null,n=null;if(t.hasStart()&&(e=t.getIndexStartValue()),t.hasEnd()&&(n=t.getIndexEndValue()),t.getIndex()===Xn){const r="Query: When ordering by key, you may only pass one argument to startAt(), endAt(), or equalTo().",i="Query: When ordering by key, the argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() must be a string.";if(t.hasStart()){if(t.getIndexStartName()!==ar)throw new Error(r);if(typeof e!="string")throw new Error(i)}if(t.hasEnd()){if(t.getIndexEndName()!==Tn)throw new Error(r);if(typeof n!="string")throw new Error(i)}}else if(t.getIndex()===se){if(e!=null&&!ad(e)||n!=null&&!ad(n))throw new Error("Query: When ordering by priority, the first argument passed to startAt(), startAfter() endAt(), endBefore(), or equalTo() must be a valid priority value (null, a number, or a string).")}else if(I(t.getIndex()instanceof Vf||t.getIndex()===F0,"unknown index type."),e!=null&&typeof e=="object"||n!=null&&typeof n=="object")throw new Error("Query: First argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() cannot be an object.")}function y1(t){if(t.hasStart()&&t.hasEnd()&&t.hasLimit()&&!t.hasAnchoredLimit())throw new Error("Query: Can't combine startAt(), startAfter(), endAt(), endBefore(), and limit(). Use limitToFirst() or limitToLast() instead.")}class Qt extends gr{constructor(e,n){super(e,n,new Gf,!1)}get parent(){const e=P0(this._path);return e===null?null:new Qt(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class Us{constructor(e,n,r){this._node=e,this.ref=n,this._index=r}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const n=new Y(e),r=li(this.ref,e);return new Us(this._node.getChild(n),r,se)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(r,i)=>e(new Us(i,li(this.ref,r),se)))}hasChild(e){const n=new Y(e);return!this._node.getChild(n).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Ci(t,e){return t=He(t),t._checkNotDeleted("ref"),e!==void 0?li(t._root,e):t._root}function li(t,e){return t=He(t),$(t._path)===null?rP("child","path",e,!1):dh("child","path",e,!1),new Qt(t._repo,ae(t._path,e))}function kP(t,e){t=He(t),l1("push",t._path),io("push",e,t._path,!0);const n=d1(t._repo),r=Rx(n),i=li(t,r),s=li(t,r);let o;return e!=null?o=IP(s,e).then(()=>s):o=Promise.resolve(s),i.then=o.then.bind(o),i.catch=o.then.bind(o,void 0),i}function IP(t,e){t=He(t),l1("set",t._path),io("set",e,t._path,!1);const n=new qs;return fP(t._repo,t._path,e,null,n.wrapCallback(()=>{})),n.promise}function TP(t,e){tP("update",e,t._path,!1);const n=new qs;return hP(t._repo,t._path,e,n.wrapCallback(()=>{})),n.promise}class vh{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,n){const r=n._queryParams.getIndex();return new g1("value",this,new Us(e.snapshotNode,new Qt(n._repo,n._path),r))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new v1(this,e,n):null}matches(e){return e instanceof vh?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}class yh{constructor(e,n){this.eventType=e,this.callbackContext=n}respondsTo(e){let n=e==="children_added"?"child_added":e;return n=n==="children_removed"?"child_removed":n,this.eventType===n}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new v1(this,e,n):null}createEvent(e,n){I(e.childName!=null,"Child events should have a childName.");const r=li(new Qt(n._repo,n._path),e.childName),i=n._queryParams.getIndex();return new g1(e.type,this,new Us(e.snapshotNode,r,i),e.prevName)}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof yh?this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)):!1}hasAnyCallback(){return!!this.callbackContext}}function _1(t,e,n,r,i){let s;if(typeof r=="object"&&(s=void 0,i=r),typeof r=="function"&&(s=r),i&&i.onlyOnce){const l=n,u=(c,d)=>{mg(t._repo,t,a),l(c,d)};u.userCallback=n.userCallback,u.context=n.context,n=u}const o=new CP(n,s||void 0),a=e==="value"?new vh(o):new yh(e,o);return mP(t._repo,t,a),()=>mg(t._repo,t,a)}function _h(t,e,n,r){return _1(t,"value",e,n,r)}function NP(t,e,n,r){return _1(t,"child_added",e,n,r)}class so{}class xP extends so{constructor(e,n){super(),this._value=e,this._key=n}_apply(e){io("endAt",this._value,e._path,!0);const n=Fx(e._queryParams,this._value,this._key);if(y1(n),gh(n),e._queryParams.hasEnd())throw new Error("endAt: Starting point was already set (by another call to endAt, endBefore or equalTo).");return new gr(e._repo,e._path,n,e._orderByCalled)}}class bP extends so{constructor(e,n){super(),this._value=e,this._key=n}_apply(e){io("startAt",this._value,e._path,!0);const n=Dx(e._queryParams,this._value,this._key);if(y1(n),gh(n),e._queryParams.hasStart())throw new Error("startAt: Starting point was already set (by another call to startAt, startBefore or equalTo).");return new gr(e._repo,e._path,n,e._orderByCalled)}}class PP extends so{constructor(e){super(),this._limit=e}_apply(e){if(e._queryParams.hasLimit())throw new Error("limitToLast: Limit was already set (by another call to limitToFirst or limitToLast).");return new gr(e._repo,e._path,Mx(e._queryParams,this._limit),e._orderByCalled)}}function RP(t){if(typeof t!="number"||Math.floor(t)!==t||t<=0)throw new Error("limitToLast: First argument must be a positive integer.");return new PP(t)}class AP extends so{constructor(e){super(),this._path=e}_apply(e){SP(e,"orderByChild");const n=new Y(this._path);if(B(n))throw new Error("orderByChild: cannot pass in empty path. Use orderByValue() instead.");const r=new Vf(n),i=Ux(e._queryParams,r);return gh(i),new gr(e._repo,e._path,i,!0)}}function w1(t){if(t==="$key")throw new Error('orderByChild: "$key" is invalid.  Use orderByKey() instead.');if(t==="$priority")throw new Error('orderByChild: "$priority" is invalid.  Use orderByPriority() instead.');if(t==="$value")throw new Error('orderByChild: "$value" is invalid.  Use orderByValue() instead.');return dh("orderByChild","path",t,!1),new AP(t)}class OP extends so{constructor(e,n){super(),this._value=e,this._key=n}_apply(e){if(io("equalTo",this._value,e._path,!1),e._queryParams.hasStart())throw new Error("equalTo: Starting point was already set (by another call to startAt/startAfter or equalTo).");if(e._queryParams.hasEnd())throw new Error("equalTo: Ending point was already set (by another call to endAt/endBefore or equalTo).");return new xP(this._value,this._key)._apply(new bP(this._value,this._key)._apply(e))}}function LP(t,e){return nP("equalTo","key",e,!0),new OP(t,e)}function E1(t,...e){let n=He(t);for(const r of e)n=r._apply(n);return n}Tb(Qt);Ab(Qt);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function BP(t){wN(Ks),ti(new rr("database",(e,{instanceIdentifier:n})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return FP(r,i,s,n)},"PUBLIC").setMultipleInstances(!0)),_n(Dm,Fm,t),_n(Dm,Fm,"esm2017")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jP={".sv":"timestamp"};function C1(){return jP}$t.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};$t.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};BP();const ki={MESSAGES:"messages",USERS:"users",MATCHES:"matches"},WP={uid:null,displayName:"Unknown User"},Ga="demo";function HP(t,e){const[n,r]=R.exports.useState([]);return R.exports.useEffect(()=>{if(!t||!e)return;const i=Si(),s=`${ki.MATCHES}/${t}`,o=Ci(i,s),a=E1(o,w1("for"),LP(e));_h(a,l=>{const u=l.val()||{},c=Object.values(u);r(c)})},[t,e]),n}async function VP(t){const e=await kk({route:`/core/user/${t}`});return e==null?void 0:e.data}function qP(t){const e=Si(),n=`${ki.USERS}/${t}`,r=Ci(e,n);return new Promise(i=>{_h(r,s=>{const o=s.val();i(o&&Ve({uid:s.key},o))})})}function S1(t){const[e,n]=R.exports.useState({});return R.exports.useEffect(()=>{Object.keys(t).filter(r=>!(r in e)).map(VP).forEach(r=>{r.then(i=>{i!=null&&i.uid&&n(s=>Xt(Ve({},s),{[i.uid]:i}))}).catch(i=>{console.log("Error while fetching many user records."),console.error(i)})})},[t,e]),e}async function k1(t){try{if(!(t!=null&&t.uid))throw new Error("No user ID provided to update user details.");const{uid:e,email:n,displayName:r,photoURL:i}=t,s=Si(),o=`${ki.USERS}/${e}`,a=Ci(s,o);return await TP(a,{uid:e,email:n,displayName:r,photoURL:i,latestLogin:C1()}),null}catch(e){return console.error("Failed to update user details."),console.log(t),console.error(e),e}}function GP(){return h("div",{className:"FloatingButton MockLoginButton",children:T(at,{to:"/mocklogin",className:"NoDecorate",children:[h(We,{icon:uv,className:"IconBefore"}),h("span",{className:"FloatingButtonTooltip",children:"Go to Mock Login"})]})})}function YP(){const[t,e]=R.exports.useState(null),n=Zs(),r=gd(),i=async()=>{const{user:o,signInError:a}=await _N();o?(await k1(o),e(null),r("/chats")):(console.error(a),e(a))},s=async()=>{const{isSuccess:o,signOutError:a}=await a0();o||e(a)};return T("div",{className:"Page LoginPage FullHeight VerticalCenter",children:[T("div",{children:[h(kf,{size:"Big",align:"Centered"}),h("h1",{className:"BigTitle",children:"Butterfly"}),h("p",{children:"Meet people in your community."}),h("p",{children:T("span",{className:"Button Primary",role:"button",tabIndex:0,onClick:i,onKeyDown:i,children:[h(We,{icon:kT,className:"IconBefore"}),h("span",{children:"Log in with Google"})]})}),T(_l,{hasError:t,children:[h("p",{children:"Something went wrong:"}),h("pre",{children:t==null?void 0:t.toString()})]}),h(l0,{authUser:n,doLogOut:s})]}),h(GP,{})]})}function KP(){var i;const{uid:t}=Og(),e=(i=S1({[t]:!0}))==null?void 0:i[t];if(!e)return h("p",{children:"User not found."});const{photoURL:n,displayName:r}=e;return T("div",{children:[h("div",{className:"ProfileImage",children:h("img",{src:n,alt:"Profile",className:"Image"})}),h("div",{className:"DisplayName",children:h("span",{children:r})})]})}function QP({match:t,users:e}){const{id:n,release_timestamp:r,participants:i}=t,s=Object.keys(i).filter(o=>o!==t.for).map(o=>(e==null?void 0:e[o])||{uid:o}).map(o=>h(Ps,{user:o},o.uid));return T("div",{className:"MatchTile Card Full",children:[T("h3",{children:["Week of ",l_(r)]}),h("div",{className:"UserRow",children:s}),h("p",{children:T(at,{to:`/chats/${n}`,className:"Button",children:[h(We,{icon:mC,className:"IconBefore"}),h("span",{children:"Open Chat"})]})})]})}const Vr={demo:{id:"demo",name:"Demo Community",intents:[{code:"tutoring",name:"Tutoring"},{code:"tv-movie-recs",name:"TV/Movie Recommendations"}],interests:[{code:"running",name:"Running"},{code:"biking",name:"Biking"},{code:"swimming",name:"Swimming"}]},sds:{id:"sds",name:"Scarlet Data Studio",intents:[],interests:[]}};function XP(){const t=Zs(),e=(Vr==null?void 0:Vr[Ga])||{},n=HP(Ga,t==null?void 0:t.uid),r=n.reduce((o,a)=>Ve(Ve({},o),a.participants),{}),i=S1(r),s=n.length>0?n.sort((o,a)=>a.release_timestamp-o.release_timestamp).map(o=>h(QP,{match:o,users:i},o.id)):h("p",{children:"No matches yet."});return T("div",{className:"AllChatsPage",children:[T("div",{className:"Header",children:[h("h1",{className:"BigTitle",children:h(at,{to:"/",children:h("span",{children:"Butterfly Chats"})})}),h("p",{children:"Each week, you will be matched to another person in your community."}),T("p",{children:[h("span",{children:"Check back on Mondays to see who you are matched with! "}),T("span",{children:["Update ",h(at,{to:"/me",children:"your profile"})," for better matches."]})]})]}),T("div",{className:"Page",children:[h("h2",{children:(e==null?void 0:e.name)||"Your Matches"}),s]})]})}const I1="MESSAGE";function JP(t){const[e,n]=R.exports.useState({});return R.exports.useEffect(()=>{const r=Si(),i=`${ki.MATCHES}/${t}`,s=Ci(r,i);return _h(s,async a=>{const l=a.val(),u=(l==null?void 0:l.participants)||{},c=await Object.keys(u).reduce(async(d,f)=>{const v=await qP(f);return Xt(Ve({},await d),{[f]:v})},u);n(Xt(Ve({isLoaded:!0,exists:a.exists()},l),{participants:c}))})},[t]),e}function ZP(t,e=50){const[n,r]=R.exports.useState({keys:{},values:[]});return R.exports.useEffect(()=>{const i=Si(),s=`${ki.MESSAGES}/${t}`,o=E1(Ci(i,s),w1("timestamp"),RP(e));return NP(o,l=>{const{key:u}=l,c=Ve({key:u},l.val());r(d=>{if(u in d.keys)return d;const{keys:f,values:v}=d;return{isLoaded:!0,keys:Xt(Ve({},f),{[u]:!0}),values:[...v,c]}})})},[t,e]),n.values}async function eR(t,e){if(!e.from)throw new Error("Missing `from` in message data.");if(!e.message)throw new Error("Missing `message` in message data.");const n={type:I1,timestamp:C1(),message:e.message,from:e.from},r=Si(),i=`${ki.MESSAGES}/${t}`,s=Ci(r,i);await kP(s,n)}function tR(t,e){return Object.keys(t).filter(n=>n!==e).sort().reduce((n,r,i)=>Xt(Ve({},n),{[r]:`Theirs Participant${i}`}),{[e]:"Mine"})}function Gi({data:t,myUserId:e,participants:n}){const{message:r,from:i,type:s}=t,o=tR(n,e);if(s!==I1)return null;const a=(n==null?void 0:n[i])||WP,l=r.split(`
`).map((u,c)=>h("p",{children:u},c));return h("div",{className:`Message ${o[i]}`,children:T("div",{className:"MessageInner",children:[h("p",{className:"Author",children:a.displayName}),h("div",{className:"Body",children:l})]})})}function nR(){return h("p",{className:"Centered",children:"Loading chat..."})}function rR(t,e,n){const r=(e==null?void 0:e.participants)||{};return e.isLoaded?e!=null&&e.exists?n in r?null:"You are not a participant in this chat.":`No chat found for ID: ${t}`:null}const Ii=R.exports.createContext();function iR({chatId:t,header:e,conversation:n,composer:r}){const{chat:i,myUserId:s}=R.exports.useContext(Ii),o=rR(t,i,s),a=i.isLoaded&&!o,l=T("div",{className:"ChatAppInner HideScroll",children:[h("div",{className:"ChatHeader HideScroll",children:e}),h("div",{className:"ChatMessages",children:n}),h("div",{className:"ChatComposer",children:r})]});return T("div",{className:"ChatApp",children:[!i.isLoaded&&h(nR,{}),a&&l,T(_l,{hasError:o,children:[h("h1",{children:"No Chat Here..."}),h("pre",{children:o})]})]})}function sR({chatId:t,header:e,conversation:n,composer:r}){const i=Zs(),s=i==null?void 0:i.uid,o=JP(`${t}~${s}`),a=ZP(t),l=c=>{!s||!c||eR(t,{message:c,from:s})},u=R.exports.useMemo(()=>({chat:o,messages:a,myUserId:s,sendChatMessage:l}));return h(Ii.Provider,{value:u,children:h(iR,{chatId:t,header:e,conversation:n,composer:r})})}function oR(){const t=R.exports.createRef(),{sendChatMessage:e}=R.exports.useContext(Ii);return T(yl,{children:[h("textarea",{ref:t,className:"Input"}),h("button",{type:"button",onClick:()=>{e(t.current.value),t.current.value=""},className:"Button Send",children:h(We,{icon:uC,className:"IconBefore"})})]})}const aR=({commonLetters:t})=>{const e=QI(t.length,"letter"),n=t.join(", ");return h("div",{className:"CommonLettersStarter",children:T("p",{children:["Fun fact, your names have ",e," in common: ",n,"!"]})})},lR=({chat:t})=>{var e;return h(aR,{commonLetters:(e=t==null?void 0:t.metadata)==null?void 0:e.commonLetters})};const uR=({})=>h("div",{}),vg=({chat:t})=>h(uR,{});const cR=({})=>h("div",{}),yg=({chat:t})=>h(cR,{});const dR=({})=>h("div",{}),_g=({chat:t})=>h(dR,{}),Ru={commonLettersGenerator:lR,rareIntentsGenerator:vg,similarIntentsGenerator:vg,rareInterestsGenerator:yg,similarInterestsGenerator:yg,limitedSchedulesGenerator:_g,similarSchedulesGenerator:_g};function fR(t){var r;const e=(r=t==null?void 0:t.metadata)==null?void 0:r.generator,n=Ru==null?void 0:Ru[e];return!e||!n?null:n}function hR(){const{chat:t,messages:e,myUserId:n}=R.exports.useContext(Ii),r=fR(t),i=r&&h("div",{children:h(r,{chat:t})},"conversation_starter"),s=h("p",{children:"Loading chat..."}),o=h("p",{children:"No messages yet, will you start things off?"}),a=t.isLoaded&&e.map(l=>h(Gi,{data:l,myUserId:n,participants:t.participants},l.key));return t.isLoaded?i?[i,...a]:e.length>0?a:o:s}function wh({label:t,icon:e,onClick:n}){return T("div",{className:"FloatingButton ChatAppMenuButton",tabIndex:0,role:"button",onClick:n,onKeyDown:n,children:[h("span",{className:"FloatingButtonTooltip",children:t}),h(We,{icon:e,className:"IconBefore"})]})}function pR({menuConfig:t,onMenuClick:e,setOption:n}){var r;return T(yl,{children:[h(wh,{label:"Close Menu",icon:fC,onClick:e}),T("div",{className:"ChatMenu",children:[h("h2",{children:"Chat Menu"}),(r=t==null?void 0:t.options)==null?void 0:r.map(i=>h("div",{className:"MenuOption",tabIndex:0,role:"button",onClick:()=>n(i.id),onKeyDown:()=>n(i.id),children:h("span",{children:i.name})},i.id))]})]})}function mR({name:t,onClick:e,children:n}){return T(yl,{children:[h(wh,{label:"Chat Menu",icon:dC,onClick:e}),T("div",{className:"ChatMenu",children:[h("h2",{children:t}),n]})]})}function gR(){return h("p",{children:"Coming soon..."})}function vR({menuConfig:t,onMenuClick:e}){var l;const n=(l=t==null?void 0:t.options)==null?void 0:l.reduce((u,c)=>Xt(Ve({},u),{[c.id]:c}),{}),[r,i]=R.exports.useState(null),s=()=>i(null),o=n==null?void 0:n[r],{chat:a}=R.exports.useContext(Ii);if(o){const u=(o==null?void 0:o.component)||gR;return h(mR,{name:o==null?void 0:o.name,onClick:s,children:h(u,{chat:a,config:o})})}return h(pR,{menuConfig:t,onMenuClick:e,setOption:i})}function yR(){return h("div",{className:"FloatingButton BackToChatsButton",children:T(at,{to:"/chats",className:"NoDecorate",children:[h(We,{icon:pC,className:"IconBefore"}),h("span",{className:"FloatingButtonTooltip",children:"Back to Chats"})]})})}function _R({chat:t,onMenuClick:e}){const n=Object.values((t==null?void 0:t.participants)||{}).map(i=>h(Ps,{user:i},i.uid)),r=l_(t==null?void 0:t.release_timestamp);return T(yl,{children:[h(yR,{}),h(wh,{label:"Open Menu",icon:cC,onClick:e}),h("h1",{children:"Butterfly Chat"}),h("p",{children:"Messages will disappear after 30 days."}),T("p",{children:["Your match for the week of ",r,"."]}),h("div",{className:"UserRowCentered",children:n})]})}function wR({menuConfig:t}){const[e,n]=R.exports.useState(!1),r=()=>n(!0),i=()=>n(!1),{chat:s}=R.exports.useContext(Ii);return e?h(vR,{menuConfig:t,onMenuClick:i}):h(_R,{chat:s,onMenuClick:r})}const ER=({})=>h("div",{}),CR=({chat:t,config:e})=>h(ER,{});const SR=({})=>h("div",{}),kR=({chat:t,config:e})=>h(SR,{});const IR=({})=>h("div",{}),TR=({chat:t,config:e})=>h(IR,{});const NR=({})=>h("div",{}),xR=({chat:t,config:e})=>h(NR,{}),bR={options:[{id:"search",name:"Search Messages",component:CR},{id:"block",name:"Block User",component:kR},{id:"rate",name:"Rate Match",component:TR},{id:"upvote",name:"Upvote User",component:xR}]};function PR(){const{chatId:t}=Og(),e=`${Ga}/${t}`;return h("div",{className:"ChatPage",children:h("div",{className:"ChatContainer",children:h(sR,{chatId:e,header:h(wR,{menuConfig:bR}),conversation:h(hR,{}),composer:h(oR,{})})})})}const RR=({})=>h("div",{});const AR=({})=>h("div",{});function OR(){const t=Zs(),e=(Vr==null?void 0:Vr[Ga])||{};return t&&T("div",{className:"EditProfilePage",children:[T("div",{className:"Header",children:[h("h1",{className:"BigTitle",children:"Edit Profile"}),h("p",{children:"Update your profile to help us give you better matches!"}),h(Ps,{user:t}),h(at,{to:"/chats",children:h("p",{children:"Back to your matches."})})]}),T("div",{className:"Page",children:[h("h2",{children:"Support"}),h(RR,{allIntents:e==null?void 0:e.intents}),h("h2",{children:"Interests"}),h("h2",{children:"Schedule"}),h(AR,{allInterests:e==null?void 0:e.interests}),h("p",{children:"Coming soon..."})]})]})}const LR="Contacting backend API...";function MR(t,e){return e?`Error: ${e}`:t?JSON.stringify(t,null,4):LR}function DR(){const[t,e]=Tk({route:"/"}),n=MR(t,e);return h("div",{className:"Layout Page",children:T("div",{children:[h("h1",{className:"BigTitle",children:"Status"}),h(at,{to:"/",children:"Back to Home"}),h("pre",{children:n})]})})}const FR="7MIFL%Jj960nT^QX",T1=[{displayName:"Pradeep Balaram",email:"scarletdatastudio+pradeep@gmail.com",photoURL:"https://randomuser.me/api/portraits/men/45.jpg"},{displayName:"Si-Woo Yun-Seo",email:"scarletdatastudio+siwoo@gmail.com",photoURL:"https://randomuser.me/api/portraits/men/92.jpg"},{displayName:"Ilya Viktoria",email:"scarletdatastudio+ilya@gmail.com",photoURL:"https://randomuser.me/api/portraits/women/31.jpg"},{displayName:"Asabe Oyibo",email:"scarletdatastudio+asabe@gmail.com",photoURL:"https://randomuser.me/api/portraits/women/89.jpg"},{displayName:"Ernesto Sa\xFAl",email:"scarletdatastudio+ernesto@gmail.com",photoURL:"https://randomuser.me/api/portraits/men/61.jpg"},{displayName:"Quy\xEAn H\u01B0\u01A1ng",email:"scarletdatastudio+quyen@gmail.com",photoURL:"https://randomuser.me/api/portraits/women/12.jpg"}],Au=T1.reduce((t,e)=>Xt(Ve({},t),{[e.email]:e}),{});async function UR(t){const e=Au==null?void 0:Au[t];if(!e)return{user:null,signInError:`No mock user for email: '${t}'`};try{const n=Tl(),{email:r,displayName:i,photoURL:s}=e,{user:o}=await s2(n,r,FR);return await a2(n.currentUser,{displayName:i,photoURL:s}),{user:o,signInError:null}}catch(n){return{user:null,signInError:n}}}function zR({mockUsers:t,doLogIn:e}){const n=R.exports.createRef(),r=()=>{const s=n.current.value;s&&e(s)},i=t.map(({email:s,displayName:o})=>h("option",{value:s,children:o},s));return T("div",{children:[h("p",{children:h("select",{ref:n,className:"LoginUserSelector",children:i})}),h("p",{children:T("span",{className:"Button Primary",role:"button",tabIndex:0,onClick:r,onKeyDown:r,children:[h(We,{icon:uv,className:"IconBefore"}),h("span",{children:"Log in as Mock User"})]})}),T("p",{children:[h(at,{to:"/login",children:"Back to Real Login"}),h("span",{children:" | "}),h(at,{to:"/status",children:"Status Page"})]})]})}function $R(){const[t,e]=R.exports.useState(null),n=Zs(),r=async s=>{const{user:o,signInError:a}=await UR(s);o?(await k1(o),e(null)):(console.error(a),e(a))},i=async()=>{const{isSuccess:s,signOutError:o}=await a0();s||e(o)};return h("div",{className:"Page LoginPage FullHeight VerticalCenter",children:T("div",{children:[h(kf,{size:"Big",align:"Centered"}),h("h1",{className:"BigTitle",children:"Butterfly"}),h("p",{children:"Meet people in your community."}),h("hr",{}),h("h2",{children:"Mock User Login"}),h(zR,{doLogIn:r,mockUsers:T1}),T(_l,{hasError:t,children:[h("p",{children:"Something went wrong:"}),h("pre",{children:t==null?void 0:t.toString()})]}),h(l0,{authUser:n,doLogOut:i})]})})}const Oo={"user-a":{displayName:"Me"},"user-b":{displayName:"User B"},"user-c":{displayName:"User C"},"user-d":{displayName:"User D"}};function BR(){return T("div",{className:"Layout",children:[h("div",{className:"Header",children:h("h1",{className:"BigTitle",children:"Style Guide"})}),T("div",{className:"Page",children:[T("section",{className:"Section",children:[h("h2",{children:"Typography"}),h("hr",{}),h("h1",{children:"Heading 1"}),h("h2",{children:"Heading 2"}),h("h3",{children:"Heading 3"}),h("h4",{children:"Heading 4"}),h("h5",{children:"Heading 5"}),h("h6",{children:"Heading 6"}),h("p",{children:"Paragraph"})]}),T("section",{className:"Section",children:[h("h2",{children:"User Elements"}),h("hr",{}),T("div",{className:"UserRow",children:[h(Ps,{user:{displayName:"Ernesto Sa\xFAl",photoURL:"https://randomuser.me/api/portraits/men/61.jpg"}}),h(Ps,{user:{displayName:"Quy\xEAn H\u01B0\u01A1ng",photoURL:"https://randomuser.me/api/portraits/women/12.jpg"}})]})]}),T("section",{className:"Section",children:[h("h2",{children:"Chat Elements"}),h("hr",{}),h(Gi,{data:{type:"MESSAGE",from:"user-a",message:`Hello,
This is a multi-paragraph message I sent!`},myUserId:"user-a",participants:Oo}),h(Gi,{data:{type:"MESSAGE",from:"user-b",message:"And I am replying to you."},myUserId:"user-a",participants:Oo}),h(Gi,{data:{type:"MESSAGE",from:"user-c",message:"I am another participant."},myUserId:"user-a",participants:Oo}),h(Gi,{data:{type:"MESSAGE",from:"user-d",message:"And I am yet another participant."},myUserId:"user-a",participants:Oo})]}),T("section",{className:"Section",children:[h("h2",{children:"Card Elements"}),h("hr",{}),h("h4",{children:"Full Cards"}),T("div",{className:"Card Full",children:[h("h4",{children:"Card 1"}),h("p",{children:"Card Content"})]}),T("div",{className:"Card Full",children:[h("h4",{children:"Card 2"}),h("p",{children:"Card Content"})]}),h("h3",{children:"Card Row"}),T("div",{className:"CardRow",children:[T("div",{className:"Card",children:[h("h4",{children:"Card A"}),h("p",{children:"Card Content"})]}),T("div",{className:"Card",children:[h("h4",{children:"Card B"}),h("p",{children:"Card Content"})]}),T("div",{className:"Card",children:[h("h4",{children:"Card C"}),h("p",{children:"Card Content"})]})]})]}),T("section",{className:"Section",children:[h("h2",{children:"Buttons"}),h("hr",{}),T("div",{className:"ButtonRow",children:[h("span",{className:"Button Primary",children:"Primary"}),h("span",{className:"Button",children:"Secondary"})]}),T("div",{className:"ButtonRow",children:[T("span",{className:"Button Primary",children:[h(We,{icon:gC,className:"IconBefore"}),h("span",{children:"With Icon"})]}),T("span",{className:"Button",children:[h(We,{icon:vC,className:"IconBefore"}),h("span",{children:"With Icon"})]})]}),h("span",{className:"Button",children:"Single Button"})]}),T("section",{className:"Section",children:[h("h2",{children:"Error Elements"}),h("hr",{}),T(_l,{hasError:!0,children:[h("h4",{children:"Something went wrong."}),h("p",{children:"We broke it, sorry about that!"})]})]}),T("section",{className:"Section",children:[h("h2",{children:"Lists"}),h("hr",{}),h("h3",{children:"Unordered List"}),T("ul",{children:[h("li",{children:"List Item 1"}),h("li",{children:"List Item 2"}),h("li",{children:"List Item 3"}),h("li",{children:"List item with a lot of content that should wrap over to the next line."})]}),h("h3",{children:"Ordered List"}),T("ol",{children:[h("li",{children:"List Item 1"}),h("li",{children:"List Item 2"}),h("li",{children:"List Item 3"}),h("li",{children:"List item with a lot of content that should wrap over to the next line."})]})]}),T("section",{className:"Section",children:[h("h2",{children:"Columns"}),h("hr",{}),h("h3",{children:"Two Columns"}),T("div",{className:"Columns",children:[T("div",{className:"Column Half",children:[h("h4",{children:"Column 1"}),h("p",{children:"Column Content"})]}),T("div",{className:"Column Half",children:[h("h4",{children:"Column 2"}),h("p",{children:"Column Content"})]})]}),h("h3",{children:"Three Columns"}),T("div",{className:"Columns",children:[T("div",{className:"Column Third",children:[h("h4",{children:"Col 1"}),h("p",{children:"Column Content"})]}),T("div",{className:"Column Third",children:[h("h4",{children:"Col 2"}),h("p",{children:"Column Content"})]}),T("div",{className:"Column Third",children:[h("h4",{children:"Col 3"}),h("p",{children:"Column Content"})]})]}),h("h3",{children:"Columns with Elements"}),T("div",{className:"Columns",children:[T("div",{className:"Column Half",children:[h("h4",{children:"Column 1"}),h("h5",{children:"List"}),T("ul",{children:[h("li",{children:"List Item 1"}),h("li",{children:"List Item 2"}),h("li",{children:"List Item 3"}),h("li",{children:"List item with a lot of content that should wrap over to the next line."})]})]}),T("div",{className:"Column Half",children:[h("h4",{children:"Column 2"}),T("div",{className:"Card Full",children:[h("h5",{children:"Card"}),h("p",{children:"Card Content"})]})]})]})]})]})]})}const jR="/butterfly",wg="butterfly__pathname";function WR(){const t=gd();return R.exports.useEffect(()=>{const e=localStorage.getItem(wg);if(e){localStorage.setItem(wg,"");const n=e.substring(jR.length);t(n)}},[t]),T(Ew,{children:[h(be,{index:!0,element:h(oT,{})}),T(be,{path:"/",element:h(rT,{}),children:[h(be,{path:"login",element:h(YP,{})}),h(be,{path:"me",element:h(OR,{})}),h(be,{path:"profile",children:h(be,{path:":uid",element:h(KP,{})})}),T(be,{path:"chats",children:[h(be,{index:!0,element:h(XP,{})}),h(be,{path:":chatId",element:h(PR,{})})]}),h(be,{path:"status",element:h(DR,{})}),h(be,{path:"mocklogin",element:h($R,{})}),h(be,{path:"resources",children:h(be,{path:"styleguide",element:h(BR,{})})})]}),h(be,{path:"*",element:h(iT,{})})]})}function HR(){const t=YI();return h("div",{className:"App Theme",children:h(KI.Provider,{value:t,children:h(WR,{})})})}const VR=[yC];aC.add(VR);document.title="Butterfly";Yu.createRoot(document.getElementById("root")).render(h(xg.StrictMode,{children:h(kw,{basename:"butterfly",children:h(HR,{})})}));
