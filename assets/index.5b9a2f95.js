 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ml(t=ny()){const e=dd(t,"auth");return e.isInitialized()?e.getImmediate():iT(t,{popupRedirectResolver:qN,persistence:[nN,HT,Ly]})}KN("Browser");async function QN(){try{const t=ml(),e=new Rt;return{user:(await cN(t,e)).user,signInError:null}}catch(t){return{user:null,signInError:t}}}async function $y(){try{const t=ml();return await WT(t),{isSuccess:!0,signOutError:null}}catch(t){return{isSuccess:!1,signOutError:t}}}function gl(){const[t,e]=R.exports.useState(null),n=ml();return R.exports.useEffect(()=>zT(n,i=>{e(s=>(s==null?void 0:s.uid)!==(i==null?void 0:i.uid)?i:s)}),[]),t}const Sm="@firebase/database",km="0.12.8";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
