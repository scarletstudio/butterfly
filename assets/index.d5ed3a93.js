 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qT(t){Ot(new Et("platform-logger",e=>new oT(e),"PRIVATE")),Ot(new Et("heartbeat",e=>new WT(e),"PRIVATE")),ct(ad,Hm,t),ct(ad,Hm,"esm2017"),ct("fire-js","")}qT("");const c0="@firebase/installations",qf="0.5.8";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const N0="installations",b2="installations-internal",x2=t=>{const e=t.getProvider("app").getImmediate(),n=N2(e),r=Sr(e,"heartbeat");return{app:e,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},P2=t=>{const e=t.getProvider("app").getImmediate(),n=Sr(e,N0).getImmediate();return{getId:()=>I2(n),getToken:i=>k2(n,i)}};function R2(){Ot(new Et(N0,x2,"PUBLIC")),Ot(new Et(b2,P2,"PRIVATE"))}R2();ct(c0,qf);ct(c0,qf,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
