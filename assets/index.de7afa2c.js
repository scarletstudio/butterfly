 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dI(t){Jr(new tr("platform-logger",e=>new Tk(e),"PRIVATE")),Jr(new tr("heartbeat",e=>new uI(e),"PRIVATE")),mn(Rc,nm,t),mn(Rc,nm,"esm2017"),mn("fire-js","")}dI("");var hI="firebase",pI="9.6.11";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Zr(t,e,n=!1){if(n)return e;try{return await e}catch(r){throw r instanceof hi&&fT(r)&&t.auth.currentUser===t&&await t.auth.signOut(),r}}function fT({code:t}){return t==="auth/user-disabled"||t==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Wr(t,e){return fl(t,"POST","/v1/accounts:signInWithIdp",cl(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function bT(t,e,n=!1){const{auth:r}=t,i="reauthenticate";try{const s=await Zr(t,Ny(r,i,e,t),n);D(s.idToken,r,"internal-error");const o=vd(s.idToken);D(o,r,"internal-error");const{sub:a}=o;return D(t.uid===a,r,"user-mismatch"),ei._forOperation(t,i,s)}catch(s){throw(s==null?void 0:s.code)==="auth/user-not-found"&&st(r,"user-mismatch"),s}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function by(t,e,n=!1){const r="signIn",i=await Ny(t,r,e),s=await ei._fromIdTokenResponse(t,r,i);return n||await t._updateCurrentUser(s.user),s}async function PT(t,e){return by(hl(t),e)}function RT(t,e,n){return PT($e(t),gi.credential(e,n))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function OT(t,{displayName:e,photoURL:n}){if(e===void 0&&n===void 0)return;const r=$e(t),s={idToken:await r.getIdToken(),displayName:e,photoUrl:n,returnSecureToken:!0},o=await Zr(r,AT(r.auth,s));r.displayName=o.displayName||null,r.photoURL=o.photoUrl||null;const a=r.providerData.find(({providerId:l})=>l==="password");a&&(a.displayName=r.displayName,a.photoURL=r.photoURL),await r._updateTokensIfNecessary(o)}function LT(t,e,n,r){return $e(t).onAuthStateChanged(e,n,r)}function MT(t){return $e(t).signOut()}const Ta="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bx(t){switch(t){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}function Hx(t){Jr(new tr("auth",(e,{options:n})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("heartbeat"),{apiKey:s,authDomain:o}=r.options;return((a,l)=>{D(s&&!s.includes(":"),"invalid-api-key",{appName:a.name}),D(!(o!=null&&o.includes(":")),"argument-error",{appName:a.name});const u={apiKey:s,authDomain:o,clientPlatform:t,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:xy(t)},c=new wT(a,l,u);return eT(c,n),c})(r,i)},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,n,r)=>{e.getProvider("auth-internal").initialize()})),Jr(new tr("auth-internal",e=>{const n=hl(e.getProvider("auth").getImmediate());return(r=>new $x(r))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),mn(Em,Cm,Bx(t)),mn(Em,Cm,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bd{constructor(e){this.initTransports_(e)}static get ALL_TRANSPORTS(){return[Rr,lt]}initTransports_(e){const n=lt&&lt.isAvailable();let r=n&&!lt.previouslyFailed();if(e.webSocketOnly&&(n||Re("wss:// URL used, but browser isn't known to support websockets.  Trying anyway."),r=!0),r)this.transports_=[lt];else{const i=this.transports_=[];for(const s of bd.ALL_TRANSPORTS)s&&s.isAvailable()&&i.push(s)}}initialTransport(){if(this.transports_.length>0)return this.transports_[0];throw new Error("No transports available")}upgradeTransport(){return this.transports_.length>1?this.transports_[1]:null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function GN(t,e){return dr(t.name,e.name)}function Od(t,e){return dr(t,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let p0,m0;function KN(t){p0=t}function QN(t){m0=t}class XN extends _l{compare(e,n){const r=e.node.getPriority(),i=n.node.getPriority(),s=r.compareTo(i);return s===0?dr(e.name,n.name):s}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,n){return!e.getPriority().equals(n.getPriority())}minPost(){return j.MIN}maxPost(){return new j(Cn,new me("[PRIORITY-POST]",m0))}makePost(e,n){const r=p0(e);return new j(n,new me("[PRIORITY-POST]",r))}toString(){return".priority"}}const se=new XN;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let _u;const gr={};class Mt{constructor(e,n){this.indexes_=e,this.indexSet_=n}static get Default(){return I(gr&&se,"ChildrenNode.ts has not been loaded"),_u=_u||new Mt({".priority":gr},{".priority":se}),_u}get(e){const n=Xr(this.indexes_,e);if(!n)throw new Error("No index defined for "+e);return n instanceof Ue?n:null}hasIndex(e){return kt(this.indexSet_,e.toString())}addIndex(e,n){I(e!==Kn,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const r=[];let i=!1;const s=n.getIterator(j.Wrap);let o=s.getNext();for(;o;)i=i||e.isDefinedOn(o.node),r.push(o),o=s.getNext();let a;i?a=Pa(r,e.getCompare()):a=gr;const l=e.toString(),u=Object.assign({},this.indexSet_);u[l]=e;const c=Object.assign({},this.indexes_);return c[l]=a,new Mt(c,u)}addToIndexes(e,n){const r=wa(this.indexes_,(i,s)=>{const o=Xr(this.indexSet_,s);if(I(o,"Missing index implementation for "+s),i===gr)if(o.isDefinedOn(e.node)){const a=[],l=n.getIterator(j.Wrap);let u=l.getNext();for(;u;)u.name!==e.name&&a.push(u),u=l.getNext();return a.push(e),Pa(a,o.getCompare())}else return gr;else{const a=n.get(e.name);let l=i;return a&&(l=l.remove(new j(e.name,a))),l.insert(e,e.node)}});return new Mt(r,this.indexSet_)}removeFromIndexes(e,n){const r=wa(this.indexes_,i=>{if(i===gr)return i;{const s=n.get(e.name);return s?i.remove(new j(e.name,s)):i}});return new Mt(r,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nb extends _l{compare(e,n){const r=e.node.compareTo(n.node);return r===0?dr(e.name,n.name):r}isDefinedOn(e){return!0}indexedValueChanged(e,n){return!e.equals(n)}minPost(){return j.MIN}maxPost(){return j.MAX}makePost(e,n){const r=_e(e);return new j(n,r)}toString(){return".value"}}const g0=new nb;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function v0(t){return{type:"value",snapshotNode:t}}function ti(t,e){return{type:"child_added",snapshotNode:e,childName:t}}function Ps(t,e){return{type:"child_removed",snapshotNode:e,childName:t}}function Rs(t,e,n){return{type:"child_changed",snapshotNode:e,childName:t,oldSnap:n}}function ib(t,e){return{type:"child_moved",snapshotNode:e,childName:t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Md{constructor(e){this.index_=e}updateChild(e,n,r,i,s,o){I(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const a=e.getImmediateChild(n);return a.getChild(i).equals(r.getChild(i))&&a.isEmpty()===r.isEmpty()||(o!=null&&(r.isEmpty()?e.hasChild(n)?o.trackChildChange(Ps(n,a)):I(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):a.isEmpty()?o.trackChildChange(ti(n,r)):o.trackChildChange(Rs(n,r,a))),e.isLeafNode()&&r.isEmpty())?e:e.updateImmediateChild(n,r).withIndex(this.index_)}updateFullNode(e,n,r){return r!=null&&(e.isLeafNode()||e.forEachChild(se,(i,s)=>{n.hasChild(i)||r.trackChildChange(Ps(i,s))}),n.isLeafNode()||n.forEachChild(se,(i,s)=>{if(e.hasChild(i)){const o=e.getImmediateChild(i);o.equals(s)||r.trackChildChange(Rs(i,s,o))}else r.trackChildChange(ti(i,s))})),n.withIndex(this.index_)}updatePriority(e,n){return e.isEmpty()?O.EMPTY_NODE:e.updatePriority(n)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ni{constructor(e,n,r){this.source=e,this.path=n,this.children=r,this.type=ct.MERGE}operationForChild(e){if(W(this.path)){const n=this.children.subtree(new G(e));return n.isEmpty()?null:n.value?new or(this.source,V(),n.value):new ni(this.source,V(),n)}else return I(z(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new ni(this.source,Q(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pr{constructor(e,n,r,i){this._repo=e,this._path=n,this._queryParams=r,this._orderByCalled=i}get key(){return W(this._path)?null:Pd(this._path)}get ref(){return new Gt(this._repo,this._path)}get _queryIdentifier(){const e=jm(this._queryParams),n=Id(e);return n==="{}"?"default":n}get _queryObject(){return jm(this._queryParams)}isEqual(e){if(e=$e(e),!(e instanceof pr))return!1;const n=this._repo===e._repo,r=Rd(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return n&&r&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+DN(this._path)}}function KP(t,e){if(t._orderByCalled===!0)throw new Error(e+": You can't combine multiple orderBy calls.")}function sh(t){let e=null,n=null;if(t.hasStart()&&(e=t.getIndexStartValue()),t.hasEnd()&&(n=t.getIndexEndValue()),t.getIndex()===Kn){const r="Query: When ordering by key, you may only pass one argument to startAt(), endAt(), or equalTo().",i="Query: When ordering by key, the argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() must be a string.";if(t.hasStart()){if(t.getIndexStartName()!==sr)throw new Error(r);if(typeof e!="string")throw new Error(i)}if(t.hasEnd()){if(t.getIndexEndName()!==Cn)throw new Error(r);if(typeof n!="string")throw new Error(i)}}else if(t.getIndex()===se){if(e!=null&&!Xc(e)||n!=null&&!Xc(n))throw new Error("Query: When ordering by priority, the first argument passed to startAt(), startAfter() endAt(), endBefore(), or equalTo() must be a valid priority value (null, a number, or a string).")}else if(I(t.getIndex()instanceof Ld||t.getIndex()===g0,"unknown index type."),e!=null&&typeof e=="object"||n!=null&&typeof n=="object")throw new Error("Query: First argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() cannot be an object.")}function X0(t){if(t.hasStart()&&t.hasEnd()&&t.hasLimit()&&!t.hasAnchoredLimit())throw new Error("Query: Can't combine startAt(), startAfter(), endAt(), endBefore(), and limit(). Use limitToFirst() or limitToLast() instead.")}class Gt extends pr{constructor(e,n){super(e,n,new Dd,!1)}get parent(){const e=u0(this._path);return e===null?null:new Gt(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class Ls{constructor(e,n,r){this._node=e,this.ref=n,this._index=r}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const n=new G(e),r=si(this.ref,e);return new Ls(this._node.getChild(n),r,se)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(r,i)=>e(new Ls(i,si(this.ref,r),se)))}hasChild(e){const n=new G(e);return!this._node.getChild(n).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function wi(t,e){return t=$e(t),t._checkNotDeleted("ref"),e!==void 0?si(t._root,e):t._root}function si(t,e){return t=$e(t),z(t._path)===null?bP("child","path",e,!1):eh("child","path",e,!1),new Gt(t._repo,ae(t._path,e))}function QP(t,e){t=$e(t),j0("push",t._path),Zs("push",e,t._path,!0);const n=H0(t._repo),r=rb(n),i=si(t,r),s=si(t,r);let o;return e!=null?o=XP(s,e).then(()=>s):o=Promise.resolve(s),i.then=o.then.bind(o),i.catch=o.then.bind(o,void 0),i}function XP(t,e){t=$e(t),j0("set",t._path),Zs("set",e,t._path,!1);const n=new $s;return UP(t._repo,t._path,e,null,n.wrapCallback(()=>{})),n.promise}function JP(t,e){xP("update",e,t._path,!1);const n=new $s;return zP(t._repo,t._path,e,n.wrapCallback(()=>{})),n.promise}class oh{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,n){const r=n._queryParams.getIndex();return new K0("value",this,new Ls(e.snapshotNode,new Gt(n._repo,n._path),r))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new Q0(this,e,n):null}matches(e){return e instanceof oh?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}class ah{constructor(e,n){this.eventType=e,this.callbackContext=n}respondsTo(e){let n=e==="children_added"?"child_added":e;return n=n==="children_removed"?"child_removed":n,this.eventType===n}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new Q0(this,e,n):null}createEvent(e,n){I(e.childName!=null,"Child events should have a childName.");const r=si(new Gt(n._repo,n._path),e.childName),i=n._queryParams.getIndex();return new K0(e.type,this,new Ls(e.snapshotNode,r,i),e.prevName)}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof ah?this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)):!1}hasAnyCallback(){return!!this.callbackContext}}function J0(t,e,n,r,i){let s;if(typeof r=="object"&&(s=void 0,i=r),typeof r=="function"&&(s=r),i&&i.onlyOnce){const l=n,u=(c,f)=>{ng(t._repo,t,a),l(c,f)};u.userCallback=n.userCallback,u.context=n.context,n=u}const o=new YP(n,s||void 0),a=e==="value"?new oh(o):new ah(e,o);return jP(t._repo,t,a),()=>ng(t._repo,t,a)}function lh(t,e,n,r){return J0(t,"value",e,n,r)}function ZP(t,e,n,r){return J0(t,"child_added",e,n,r)}class eo{}class eR extends eo{constructor(e,n){super(),this._value=e,this._key=n}_apply(e){Zs("endAt",this._value,e._path,!0);const n=ub(e._queryParams,this._value,this._key);if(X0(n),sh(n),e._queryParams.hasEnd())throw new Error("endAt: Starting point was already set (by another call to endAt, endBefore or equalTo).");return new pr(e._repo,e._path,n,e._orderByCalled)}}class tR extends eo{constructor(e,n){super(),this._value=e,this._key=n}_apply(e){Zs("startAt",this._value,e._path,!0);const n=lb(e._queryParams,this._value,this._key);if(X0(n),sh(n),e._queryParams.hasStart())throw new Error("startAt: Starting point was already set (by another call to startAt, startBefore or equalTo).");return new pr(e._repo,e._path,n,e._orderByCalled)}}class nR extends eo{constructor(e){super(),this._limit=e}_apply(e){if(e._queryParams.hasLimit())throw new Error("limitToLast: Limit was already set (by another call to limitToFirst or limitToLast).");return new pr(e._repo,e._path,ab(e._queryParams,this._limit),e._orderByCalled)}}function rR(t){if(typeof t!="number"||Math.floor(t)!==t||t<=0)throw new Error("limitToLast: First argument must be a positive integer.");return new nR(t)}class iR extends eo{constructor(e){super(),this._path=e}_apply(e){KP(e,"orderByChild");const n=new G(this._path);if(W(n))throw new Error("orderByChild: cannot pass in empty path. Use orderByValue() instead.");const r=new Ld(n),i=cb(e._queryParams,r);return sh(i),new pr(e._repo,e._path,i,!0)}}function Z0(t){if(t==="$key")throw new Error('orderByChild: "$key" is invalid.  Use orderByKey() instead.');if(t==="$priority")throw new Error('orderByChild: "$priority" is invalid.  Use orderByPriority() instead.');if(t==="$value")throw new Error('orderByChild: "$value" is invalid.  Use orderByValue() instead.');return eh("orderByChild","path",t,!1),new iR(t)}class sR extends eo{constructor(e,n){super(),this._value=e,this._key=n}_apply(e){if(Zs("equalTo",this._value,e._path,!1),e._queryParams.hasStart())throw new Error("equalTo: Starting point was already set (by another call to startAt/startAfter or equalTo).");if(e._queryParams.hasEnd())throw new Error("equalTo: Ending point was already set (by another call to endAt/endBefore or equalTo).");return new eR(this._value,this._key)._apply(new tR(this._value,this._key)._apply(e))}}function oR(t,e){return NP("equalTo","key",e,!0),new sR(t,e)}function e1(t,...e){let n=$e(t);for(const r of e)n=r._apply(n);return n}Jb(Gt);iP(Gt);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hR(t){qx(Vs),Jr(new tr("database",(e,{instanceIdentifier:n})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return uR(r,i,s,n)},"PUBLIC").setMultipleInstances(!0)),mn(Sm,km,t),mn(Sm,km,"esm2017")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pR={".sv":"timestamp"};function t1(){return pR}Ft.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};Ft.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};hR();const Ci={MESSAGES:"messages",USERS:"users",MATCHES:"matches"},n1="MESSAGE",r1={uid:null,displayName:"Unknown User"},i1="demo";async function s1(t){try{if(!(t!=null&&t.uid))throw"No user ID provided to update user details.";const{uid:e,email:n,displayName:r,photoURL:i}=t,s=Ei(),o=`${Ci.USERS}/${e}`,a=wi(s,o);return await JP(a,{uid:e,email:n,displayName:r,photoURL:i,latestLogin:t1()}),null}catch(e){return console.error("Failed to update user details."),console.log(t),console.error(e),e}}function o1({authUser:t,doLogOut:e}){return t&&ne("div",{children:[k("hr",{}),ne("p",{children:["Currently logged in as ",t.displayName,"."]}),k("p",{children:k(li,{to:"/chats",children:"Go to Chats"})}),k("p",{children:ne("span",{className:"Button",onClick:e,children:[k(Nn,{icon:QE,className:"IconBefore"}),k("span",{children:"Log Out"})]})})]})}function uh({hasError:t,children:e}){return t&&k("div",{className:"Error",children:e})}function mR(){const[t,e]=A.exports.useState(null),n=vl(),r=af(),i=async()=>{const{user:o,signInError:a}=await Vx();o?(await s1(o),console.log(`Welcome, ${o.displayName}!`),e(null),r("/chats")):(console.error(a),e(a))},s=async()=>{const{isSuccess:o,signOutError:a}=await jy();o||e(a)};return k("div",{className:"Page Content LoginPage FullPage VerticalCenter",children:ne("div",{children:[k("h1",{className:"BigTitle",children:"Butterfly"}),k("p",{children:"Meet people in your community."}),k("p",{children:ne("span",{className:"Button Primary",onClick:i,children:[k(Nn,{icon:QI,className:"IconBefore"}),k("span",{children:"Log in with Google"})]})}),ne(uh,{hasError:t,children:[k("p",{children:"Something went wrong:"}),k("pre",{children:t==null?void 0:t.toString()})]}),k(o1,{authUser:n,doLogOut:s})]})})}function gR(t,e){const[n,r]=A.exports.useState([]);return A.exports.useEffect(()=>{if(!t||!e)return;const i=Ei(),s=`${Ci.MATCHES}/${t}`,o=wi(i,s),a=e1(o,Z0("for"),oR(e));lh(a,l=>{const u=l.val()||{},c=Object.values(u);r(c)})},[t,e]),n}function vR({data:t}){const{id:e,release_tag:n,title:r}=t;return ne("div",{className:"Match",children:[k("h3",{children:n}),k("p",{children:k(li,{to:`/chats/${e}`,children:r})})]})}function _R(){const t=vl(),e=gR(i1,t==null?void 0:t.uid),n=e.length>0?e.map(r=>k(vR,{data:r},r.id)):k("p",{children:"Loading matches..."});return ne("div",{className:"Page Content AllChatsPage FullPage",children:[k("h1",{children:"Chats"}),k("p",{children:"Your chats will appear here."}),k("h2",{children:"Demo Community"}),n]})}function yR(t){const e=Ei(),n=`${Ci.USERS}/${t}`,r=wi(e,n);return new Promise((i,s)=>{lh(r,o=>{i(An({uid:o.key},o.val()))})})}function wR(t){const[e,n]=A.exports.useState({});return A.exports.useEffect(()=>{const r=Ei(),i=`${Ci.MATCHES}/${t}`,s=wi(r,i);return lh(s,async a=>{const l=a.val(),u=(l==null?void 0:l.participants)||{},c=await Object.keys(u).reduce(async(f,d)=>{const g=await yR(d);return Si(An({},await f),{[d]:g})},u);n(Si(An({isLoaded:!0,exists:a.exists()},l),{participants:c}))})},[t]),e}function ER(t,e=50){const[n,r]=A.exports.useState({keys:{},values:[]});return A.exports.useEffect(()=>{const i=Ei(),s=`${Ci.MESSAGES}/${t}`,o=e1(wi(i,s),Z0("timestamp"),rR(e));return ZP(o,l=>{const u=l.key,c=An({key:u},l.val());r(f=>{if(u in f.keys)return f;const{keys:d,values:g}=f;return{isLoaded:!0,keys:Si(An({},d),{[u]:!0}),values:[...g,c]}})})},[t]),n.values}async function CR(t,e){if(!e.from)throw"Missing `from` in message data.";if(!e.message)throw"Missing `message` in message data.";const n={type:n1,timestamp:t1(),message:e.message,from:e.from},r=Ei(),i=`${Ci.MESSAGES}/${t}`,s=wi(r,i);await QP(s,n)}function SR({data:t,myUserId:e,participants:n}){const{message:r,from:i,type:s,timestamp:o}=t;if(s!==n1)return null;const a=(n==null?void 0:n[i])||r1;return k("div",{className:`Message ${i===e?"Mine":"Theirs"}`,children:ne("div",{className:"MessageInner",children:[k("p",{children:a.displayName}),k("p",{children:r})]})})}function kR({chatId:t,chat:e,myUserId:n}){const r=ER(t),i=e.isLoaded&&r.length>0,s=i&&r.map(a=>k(SR,{data:a,myUserId:n,participants:e.participants},a.key));return k("div",{className:"ChatMessages",children:i?s:k("p",{children:"No messages yet... Will you start things off?"})})}function IR({chatId:t,myUserId:e}){const n=A.exports.createRef();return ne("div",{className:"ChatComposer",children:[k("textarea",{ref:n,className:"Input"}),k("button",{onClick:()=>{const i=n.current.value;!e||!i||(CR(t,{message:i,from:e}),n.current.value="")},className:"Button Send",children:k(Nn,{icon:GE,className:"IconBefore"})})]})}function TR(t,e={}){const n=Object.keys(e).filter(r=>r!==t);return(e==null?void 0:e[n==null?void 0:n[0]])||r1}function xR({myUserId:t,chat:e}){const n=TR(t,e.participants);return k("div",{className:"ChatHeader",children:ne("h1",{children:["Chat with ",n.displayName]})})}function NR(){return k("p",{children:"Loading chat..."})}function bR(t,e,n){const r=(e==null?void 0:e.participants)||{};if(e.isLoaded)if(e!=null&&e.exists){if(!(n in r))return"You are not a participant in this chat."}else return`No chat found for ID: ${t}`;else return null;return null}function PR({chatId:t}){const e=vl(),n=e==null?void 0:e.uid,r=wR(`${t}~${n}`),i=bR(t,r,n),s=r.isLoaded&&!i,o=ne(bI,{children:[k(xR,{myUserId:n,chat:r}),k(kR,{chatId:t,myUserId:n,chat:r}),k(IR,{chatId:t,myUserId:n})]});return ne("div",{className:"ChatApp",children:[!r.isLoaded&&k(NR,{}),s&&o,ne(uh,{hasError:i,children:[k("h1",{children:"No Chat Here..."}),k("pre",{children:i})]})]})}function RR(){const{chatId:t}=ew(),e=`${i1}/${t}`;return k("div",{className:"Content ChatPage FullPage",children:ne("div",{className:"ChatContainer",children:[k(PR,{chatId:e}),k("p",{children:k(li,{to:"/chats",children:"Back to Chats"})})]})})}const AR="7MIFL%Jj960nT^QX",a1=[{displayName:"Pradeep Balaram",email:"scarletdatastudio+pradeep@gmail.com",photoURL:"https://randomuser.me/api/portraits/men/45.jpg"},{displayName:"Si-Woo Yun-Seo",email:"scarletdatastudio+siwoo@gmail.com",photoURL:"https://randomuser.me/api/portraits/men/92.jpg"},{displayName:"Ilya Viktoria",email:"scarletdatastudio+ilya@gmail.com",photoURL:"https://randomuser.me/api/portraits/women/31.jpg"},{displayName:"Asabe Oyibo",email:"scarletdatastudio+asabe@gmail.com",photoURL:"https://randomuser.me/api/portraits/women/89.jpg"},{displayName:"Ernesto Sa\xFAl",email:"scarletdatastudio+ernesto@gmail.com",photoURL:"https://randomuser.me/api/portraits/men/61.jpg"},{displayName:"Quy\xEAn H\u01B0\u01A1ng",email:"scarletdatastudio+quyen@gmail.com",photoURL:"https://randomuser.me/api/portraits/women/12.jpg"}],Cu=a1.reduce((t,e)=>Si(An({},t),{[e.email]:e}),{});async function OR(t){const e=Cu==null?void 0:Cu[t];if(!e)return{user:null,signInError:`No mock user for email: '${t}'`};try{const n=gl(),{email:r,displayName:i,photoURL:s}=e,a=(await RT(n,r,AR)).user;return await OT(n.currentUser,{displayName:i,photoURL:s}),{user:a,signInError:null}}catch(n){return{user:null,signInError:n}}}function LR({mockUsers:t,doLogIn:e}){const n=A.exports.createRef(),r=()=>{const s=n.current.value;s&&e(s)},i=t.map(({email:s,displayName:o})=>k("option",{value:s,children:o},s));return ne("div",{children:[k("p",{children:k("select",{ref:n,className:"LoginUserSelector",children:i})}),k("p",{children:ne("span",{className:"Button Primary",onClick:r,children:[k(Nn,{icon:XE,className:"IconBefore"}),k("span",{children:"Log in as Mock User"})]})}),k("p",{children:k(li,{to:"/login",children:"Back to Real Login"})})]})}function MR(){const[t,e]=A.exports.useState(null),n=vl(),r=async s=>{const{user:o,signInError:a}=await OR(s);o?(await s1(o),console.log(`Welcome, ${o.displayName}!`),e(null)):(console.error(a),e(a))},i=async()=>{const{isSuccess:s,signOutError:o}=await jy();s||e(o)};return k("div",{className:"Page Content LoginPage FullPage VerticalCenter",children:ne("div",{children:[k("h1",{className:"BigTitle",children:"Butterfly"}),k("p",{children:"Meet people in your community."}),k("hr",{}),k("h2",{children:"Mock User Login"}),k(LR,{doLogIn:r,mockUsers:a1}),ne(uh,{hasError:t,children:[k("p",{children:"Something went wrong:"}),k("pre",{children:t==null?void 0:t.toString()})]}),k(o1,{authUser:n,doLogOut:i})]})})}const DR="/butterfly",ig="butterfly__pathname";function FR(){const t=af();return A.exports.useEffect(()=>{const e=localStorage.getItem(ig);if(e){localStorage.setItem(ig,"");const n=e.substring(DR.length);t(n)}},[]),k("div",{className:"App Theme",children:ne(sw,{children:[k(Tt,{index:!0,element:k(AI,{})}),ne(Tt,{path:"/",element:k(PI,{}),children:[k(Tt,{path:"login",element:k(mR,{})}),ne(Tt,{path:"chats",children:[k(Tt,{index:!0,element:k(_R,{})}),k(Tt,{path:":chatId",element:k(RR,{})})]}),k(Tt,{path:"mocklogin",element:k(MR,{})})]}),k(Tt,{path:"*",element:k(RI,{})})]})})}function UR(){const t=EI();return k("div",{className:"App Theme",children:k(CI.Provider,{value:t,children:k(FR,{})})})}const zR=[YE];VE.add(zR);document.title="Butterfly";Uu.createRoot(document.getElementById("root")).render(k(dg.StrictMode,{children:k(lw,{basename:"butterfly",children:k(UR,{})})}));
